...
AGO.Main = {
  ...
  Run: function() {
    ...
    if ((a = document.getElementById("menuTableTools")))
      (b = document.createDocumentFragment()),
        ...
        (d = 1 < AGO.App.beta ? "AGOalpha" : AGO.App.beta ? "AGObeta" : "AGO"),
        DOM.appendSPAN(c, "textlabel", d),
        DOM.appendSPAN(c, { id: "ago_menubutton_coords" }),
        DOM.prependChild(a, b),
        !AGO.App.disabled &&
          30 < AGO.Notify.problem &&
          DOM.setStyleColor("ago_menubutton", "id", "#FF0000");
    if (20 > AGO.Notify.problem) {
      a = document.getElementById("logoLink");
      b = ["", "fleet1", "movement", "galaxy", "messages"][
        AGO.Option.get("O03", 2)
      ];
      a && b && (a.parentNode.href = AGO.Uni.path + b);
      if ((a = document.getElementById("playerName")))
        if (
          (3 !== a.childNodes[0].nodeType
            ? DOM.prependChild(a, document.createTextNode(AGO.App.title + " "))
            : (a.childNodes[0].textContent = AGO.App.title + " "),
          (d = a.querySelector(".status_abbr_outlaw")) && d.title)
        ) {
          b = "";
  ...
  onKeydown: function(a) {
    var b;
    return 112 <= a.keyCode && 123 >= a.keyCode && AGO.Option.is("U32")
      ? ((b = document.querySelectorAll(
          "#planetList .smallplanet a.planetlink"
        )) &&
          b[a.keyCode - 112] &&
          DOM.click(
  ...
  onSwipe: function(a, b) {
    ...
    else if (15 === b) AGO.Planets.onSwipe(a);
  },
  Display: function() {
    var a, b, d;
    d = "inactive";
    AGO.Option.is("I83") &&
      ((a = AGO.Panel.GetActive("Target", "coords", 6)),
      (b = AGO.Task.cutCoords(a)),
      (a = OBJ.get(AGO.Styles.colorType, +a.split(":")[3] || 1) || ""),
      (d = b || AGO.Panel.GetActive("Target", "time") ? "autocopy" : "coords"));
  ...
  updateButton: function() {
    5 < AGO.Init.status &&
      DOM.setStyleColor("ago_menubutton", "id", AGO.Notify.color || "");
  },
      ...
      if (!(c = document.getElementById("ago_menubutton_info"))) {
        ...
        (e = document.getElementById("ago_menubutton"))
          ? ((f = document.createElement("li")),
            (f.className = "ago_menubutton_info"),
            (c = f.appendChild(document.createElement("div"))),
            (c.id = "ago_menubutton_info"),
            DOM.after(e.parentNode, f))
          : (c = void 0);
      }
      c &&
        (DOM.hasChildren(c) ||
          ((c.parentNode.style.display = "list-item"),
          window.setTimeout(AGO.Main.hideInfo, AGO.Notify.loading ? 4e3 : 2e3)),
        (a =
          document.getElementById("ago_menubutton_info_" + a) ||
          DOM.append(
            c,
            "span",
            { id: "ago_menubutton_info_" + a },
            { display: "block" }
          )),
        DOM.updateText(a, null, b),
        DOM.updateStyle(a, null, "color", d));
    }
  },
  hideInfo: function() {
    var a;
  ...
  updateTitle: function() {
    var a, b;
    0 < AGO.Main.modeTitle &&
      (DOM.getProperty("eventboxBlank", "id", "offsetHeight", 2)
        ? ((document.title = AGO.App.title), AGO.Main.modeTitle--)
        : ((a = DOM.getText("tempcounter", "id")),
          (b = DOM.getText("eventContent", "id")),
          a && b && (document.title = AGO.App.title + " - " + a + " - " + b)));
  },
  Check: function() {},
  addVersionCheck: function(a) {
    var b, d, c, e;
    c =
      NMR.parseVersion(AGO.App.versionOGameMax) >=
      NMR.parseVersion(AGO.App.versionOGame);
    b = document.getElementById("oGameVersionCheckData");
    b ||
      ((a = a.appendChild(document.createElement("li"))),
      (b = DOM.appendDIV(
        a,
        { id: "oGameVersionCheckData" },
        { display: "none" }
      )),
      (d = DOM.appendA(
        a,
      ...
      (e =
        {
          ...
          TR: "Scriptler",
          TW: "\u811a\u672c"
        }[AGO.Uni.lang] || "Scripts"),
      DOM.appendSPAN(d, "textlabel", e),
      c && AGO.Option.is("O02") && DOM.setStyleDisplay(a));
    ...
    (d = d || document.getElementById("oGameVersionCheckMenuButton")) &&
      ...
      ((b = 6),
      window.localStorage &&
        ((c = window.localStorage.getItem("OGameVersionCheck") || ""),
        (b = parseInt(c.split("|")[1], 10) || 0),
        c.split("|")[0] !== AGO.ogameVersion && (b = 0)),
      6 > b &&
        "#FF4B00" !== d.style.color &&
        (window.localStorage &&
          window.localStorage.setItem(
            "OGameVersionCheck",
            AGO.App.versionOGame + "|" + (b + 1)
          ),
    ...
    if (a)
      if ((DOM.setStyleDisplay("inhalt", "id", b ? "block" : "none"), b))
        ...
        d = DOM.appendDIV(b, null, {
          background:
            'url("http://gf1.geo.gfsrv.net/cdn63/10e31cd5234445e4084558ea3506ea.gif") no-repeat scroll 0px 0px transparent',
          height: "28px",
          marginTop: "8px",
          position: "relative",
          textAlign: "center"
        ...
        d = DOM.appendDIV(b, null, {
          background:
            'url("http://gf1.geo.gfsrv.net/cdn9e/4f73643e86a952be4aed7fdd61805a.gif") repeat-y scroll 5px 0px transparent',
        ...
        if (e)
          for (g = 0; g < e.childNodes.length; g++)
            (f = e.childNodes[g].childNodes[2].textContent),
              (c = DOM.append(d, "p", null, {
                padding: "3px 0px",
                color:
                  "true" === e.childNodes[g].childNodes[3].textContent
                    ? "#008000"
                    : "#FF4B00"
              })),
              DOM.appendTEXT(c, e.childNodes[g].childNodes[0].textContent),
              (DOM.appendA(c, {
                href: f,
                target: "_blank"
              }).textContent =
        ...
        DOM.appendDIV(b, null, {
          background:
            'url("http://gf1.geo.gfsrv.net/cdn30/aa3e8edec0a2681915b3c9c6795e6f.gif") no-repeat scroll 2px 0px transparent',
          height: "17px"
        });
        DOM.prependChild(a, b);
      }
...
AGO.Planets = {
  ...
  Messages: function(a, b) {
    "Action" === a
      ? AGO.Planets.Action(b)
      : "Display" === a && AGO.Planets.Display();
  },
  Timer: function() {
  ...
  onSwipe: function(a) {
    "left" === a
      ? AGO.Planets.Action({ mode: "set", type: 1 })
      : "right" === a
        ? AGO.Planets.Action({
            mode: "set",
            type: 3
            ...
            if (1 === b.nodeType)
              if (((f = b.className || ""), -1 < f.indexOf("planetlink")))
                for (
                  ...
                  1 === d.nodeType &&
                    ((f = d.className || ""),
                    -1 < f.indexOf("planetPic")
                      ? (c.img = d.src)
                      : -1 < f.indexOf("planet-koords") &&
                        (c.coords = (d.textContent || "").replace(
                          /[^\d\:]/g,
                          ""
                        )));
                ...
                for (
                  f = b.title || "",
                    c.moon = STR.check(
                      NMR.parseIntAbs(STR.getParameter("cp", b.href))
                    ),
                    e.name = (
                      f.split("[", 1)[0].split("<b>", 2)[1] || ""
                    ).trim(),
                  ...
                  1 === d.nodeType &&
                    ((f = d.className || ""),
                    -1 < f.indexOf("icon-moon") && (e.img = d.src));
              else
                -1 < f.indexOf("constructionIcon") &&
                  ((d = b.querySelector(".icon_wrench_red") ? -1 : 1),
                  -1 < f.indexOf("moon")
                    ? (e.construction = d)
                    : (c.construction = d));
          c.coords &&
            ((c.coordstype = c.coords + ":1"),
            (AGO.Planets.Data[h] = c),
            (AGO.Planets.ByCoords[c.coords] = h),
            (AGO.Planets.ByIndex[c.index] = h),
            (AGO.Planets.ByCoordstype[c.coordstype] = h),
            c.moon &&
              ((e.coords = c.coords),
              (e.coordstype = c.coords + ":3"),
              (AGO.Planets.Data[c.moon] = e),
              (AGO.Planets.ByCoordstype[e.coordstype] = c.moon)));
        }
      }
    else
  ...
  Run: function() {
    ...
    (a = document.getElementById("rechts")) &&
      ...
      DOM.appendSPAN(a, "ago_planets_arrow_planet"),
      DOM.appendSPAN(a, "ago_planets_arrow_moon"),
      DOM.appendChild(document.getElementById("countColonies"), a),
      DOM.iterateChildren(document.getElementById("planetList"), function(a) {
        var e, f;
        DOM.setAttribute(
          ".activity img",
          a,
          "src",
          "/cdn/img/galaxy/activity15.gif"
        );
        f = STR.check(NMR.parseIntAbs(a.id));
        AGO.Planets.Data[f] &&
          (AGO.Planets.coloring &&
            AGO.Acc.coords === AGO.Planets.Data[f].coords &&
            DOM.extendClass(a, null, AGO.Token.getClassHighlight(AGO.Acc.type)),
          d &&
            DOM.appendSPAN(
              a,
              "ago_planets_shortcut",
              AGO.Planets.Data[f].index
            ),
          b &&
            (AGO.Planets.Data[f].construction &&
              ((e = (a.querySelector(".constructionIcon:not(.moon)") || {})
                .title),
              DOM.appendSPAN(a, "ago_planets_construction", e)),
            AGO.Planets.Data[f].moon &&
              AGO.Planets.Data[AGO.Planets.Data[f].moon].construction &&
              ((e = (a.querySelector(".constructionIcon.moon") || {}).title),
              DOM.appendSPAN(a, "ago_planets_construction_moon", e))));
      }),
      AGO.Planets.coloring &&
        DOM.addEvents("rechts", "id", {
    ...
    if ((b = document.getElementById("planetList"))) {
      if (a || 0 < AGO.Planets.updateDisplayStatus)
        AGO.Planets.updateDisplayStatus--,
          AGO.Planets.iterate(3, function(a, h) {
            if ((c = AGO.Fleet.Get("Cooldown", h, 2)))
              (c =
                3600 / AGO.Uni.speedFleet -
                (AGO.Time.timestamp() - Math.max(c, 1e4))),
                0 <= c
                  ? ((AGO.Planets.updateDisplayStatus = 5),
                    (e =
                      "ago_planets_cooldown" +
                      (60 >= c ? " ago_planets_cooldown_seconds" : "")),
                    (f = 60 < c ? Math.ceil(c / 60) : Math.floor(c) || ""),
                    (d = b.querySelector(
                      "#planet-" + a.planet + " .ago_planets_cooldown"
                    ))
                      ? (DOM.updateText(d, null, f),
                        DOM.updateClass(d, null, e))
                      : (d = b.querySelector(
                          "#planet-" + a.planet + " .moonlink"
                        )) && DOM.appendSPAN(d, e, f))
                  : AGO.Fleet.Get("Cooldown", h, 0, 2);
          });
      AGO.Planets.coloring &&
        AGO.Planets.Task.coords &&
        AGO.Planets.Task.coordstype !==
          AGO.Planets.Task.coords + ":" + AGO.Planets.Task.type &&
        DOM.iterateChildren(b, function(a) {
          var b, c;
          (b = STR.check(NMR.parseIntAbs(a.id))) &&
            AGO.Planets.Data[b] &&
            AGO.Planets.Data[b].coords === AGO.Planets.Task.coords &&
            (3 !== AGO.Planets.Task.type ||
              AGO.Planets.Data[b].moon ||
              (AGO.Planets.Task.type = 1),
  ...
  Get: function(a, b, d) {
    b =
      (a = AGO.Planets.GetId(a)) && AGO.Planets.Data[a] && b
        ? AGO.Planets.Data[a][b]
        : "";
  ...
  GetId: function(a) {
    return a && AGO.Planets.Data[a]
      ? a
      : "active" === a
        ? AGO.Acc.planetId
        : AGO.Planets.ByCoordstype[a] || "";
  },
  getHome: function() {
    var a;
  ...
  click: function(a) {
    ...
    a &&
      ...
      (a =
        "A" === a.target.nodeName
          ? a.target
          : "A" === a.target.parentNode.nodeName
            ? a.target.parentNode
            : null) &&
      ((b = -1 < (a.className || "").indexOf("moon") ? 3 : 1),
      DOM.removeClassGroup(a.parentNode, null, "ago_highlight"),
      DOM.extendClass(
        a.parentNode,
        null,
        AGO.Token.getClassHighlight(b, "active")
      ));
  },
  clickArrow: function(a) {
    a &&
      a.target &&
      (a = DOM.hasClass(a.target, null, "ago_planets_arrow_moon")
        ? 3
        : DOM.hasClass(a.target, null, "ago_planets_arrow_planet")
          ? 1
          : 0) &&
      AGO.Planets.Action({
        scroll: "down",
      ...
      (b =
        "A" === a.target.nodeName
          ...
          : "A" === a.target.parentNode.nodeName
            ...
            : null) &&
      ((a =
        "mouseover" === a.type && -1 < (b.className || "").indexOf("moon")
          ? "ago_hover_S3"
          : "ago_hover_S1"),
      DOM.setClassGroup(b.parentNode, null, "ago_hover", a));
  },
  Action: function(a) {
    var b, d, c;
    if (OBJ.is(a)) {
      ...
      if (a.scroll) {
        ...
        do
          if (
            ("down" === a.scroll
              ? (b++, b >= AGO.Planets.ByIndex.length && (b = 1))
      ...
      "set" === a.mode
        ? (b = document.querySelectorAll(
          ...
          DOM.click(1 === a.type ? "a.planetlink" : "a.moonlink", b.parentNode)
        : "select" === a.mode &&
          AGO.Planets.coloring &&
          ((AGO.Planets.Task.coords = a.coords),
          (AGO.Planets.Task.type = a.type),
          AGO.Planets.Display());
    }
  },
  iterate: function(a, b) {
    ...
    for (c = 1; c < AGO.Planets.ByIndex.length; c++)
      (d = AGO.Planets.ByIndex[c]),
        AGO.Planets.Data[d] &&
          ((a && 1 !== a) || b(AGO.Planets.Data[d], d),
          (d = AGO.Planets.Data[d].moon),
          !d || (a && 3 !== a) || b(AGO.Planets.Data[d], d));
  }
};
AGO.Panel = {
  displayStatus: 0,
  ...
  Messages: function(a, b) {
    "Display" === a
      ? AGO.Panel.Display(b)
      : "updateTab" === a
        ? AGO.Panel.updateTab(b)
        : "Action" === a
          ? AGO.Panel.Action(b)
          : "hover" === a && AGO.Panel.hoverExtern(b);
  },
  Timer: function() {},
  Init: function(a, b) {
    ...
    b &&
      ...
      window.setTimeout(function() {
        ...
        AGO.Option.is("I81") &&
          (a[0] || a[1]) &&
          AGO.Init.Messages("Token", "Action", {
            action: "set",
            tab: "Target",
            token: 81,
            coords: a[0],
  ...
  Run: function() {
    AGO.Option.is("I00") &&
      ...
      AGO.Option.is("I03")
        ? ((AGO.Panel.width = Math.min(
            AGO.Option.get("I03", 2),
            AGO.Panel.place + 190
          )),
          (AGO.Panel.space = NMR.minMax(
            Math.ceil((AGO.Panel.place - AGO.Panel.width) / 2),
            3,
            40
          )))
        : ((AGO.Panel.space = NMR.minMax(
            Math.ceil((AGO.Panel.place - 220) / 3),
            3,
            40
          )),
          (AGO.Panel.width = NMR.minMax(
            AGO.Panel.place - 4 - 2 * AGO.Panel.space,
            190,
            290
          ))),
      (AGO.Panel.innerWidth = AGO.Panel.width - 8),
      (AGO.Panel.left = -(AGO.Panel.width + AGO.Panel.space + 4)),
      (AGO.Panel.slideLeft = -(AGO.Panel.place - 1)),
      (AGO.Panel.height = NMR.minMax(
        AGO.Option.get("I04", 2) ||
          (+window.innerHeight || 0) - (AGO.Option.is("commander") ? 55 : 90),
        400,
        1200
      )),
      AGO.Option.is("T00") || AGO.Panel.set("Tools", "label", ""),
      AGO.Panel.Show());
    AGO.Box.Run();
  },
  onSwipe: function(a) {
  ...
  Show: function() {
    ...
    if ((a = document.getElementById("box")))
      (b = document.createDocumentFragment()),
        (d =
          (AGO.Panel.left < AGO.Panel.slideLeft ? "ago_panel_slide " : "") +
          (OBJ.get(AGO.Styles.classVisible, AGO.Option.get("I02", 2)) || "")),
        (d = DOM.appendDIV(b, {
          class: d,
          id: "ago_panel_button"
        })),
        DOM.appendSPAN(d, "ago_panel_arrow"),
        (f = DOM.appendDIV(
          b,
          { id: "ago_panel" },
          { left: AGO.Panel.left + "px" }
        )),
        (c = DOM.appendDIV(
          f,
          { class: "ago_panel_wrapper" },
          {
            width: AGO.Panel.width + "px",
            minHeight: AGO.Panel.height + "px"
          }
        )),
        DOM.appendSPAN(c, "ago_panel_arrow"),
        OBJ.iterate(AGO.Panel.Data, function(a) {
          if (
            AGO.Panel.Get(a, "label", 6) &&
            ((e = DOM.appendDIV(c, { id: "ago_panel_" + a })),
            (f = DOM.appendDIV(e, {
              class: "ago_panel_tab",
              "ago-data": JSON.stringify({
                update: { tab: a, status: "toggle" }
              })
            })),
            (f.textContent = AGO.Label.get(AGO.Panel.Get(a, "label", 6))),
            DOM.appendSPAN(f, "ago_panel_tab_info"),
            DOM.appendDIV(e, "ago_panel_tab_header"),
            DOM.appendDIV(e, "ago_panel_tab_content"),
            DOM.appendDIV(e, "ago_panel_tab_footer"),
            AGO.Panel.Get(a, "status"))
          ) {
            if ("Settings" === a) AGO.Panel.createSettings(e, a, "");
            else
              AGO.Panel["create" + a](
                e,
                a,
                AGO.Panel.Get(a, "data", 6),
                AGO.Panel.Data.Cache
              );
        ...
        AGO.Panel.updateTab(),
        DOM.addEventsAll(
          "#ago_panel_button, #ago_panel .ago_panel_wrapper",
          null,
          {
  ...
  set: function(a, b, d, c) {
    a &&
      b &&
      AGO.Panel.Data[a] &&
      ((AGO.Panel.Data[a][b] = d),
      c ||
        AGB.message("Panel", "Set", {
          tab: a,
          key: b,
          value: d
        }));
  ...
  Display: function(a) {
    ...
    if (5 < AGO.Init.status && !AGO.Panel.updateDisplayLock) {
      ...
      if (b.tab && AGO.Panel.Data[b.tab]) {
        "Settings" !== b.tab &&
          ("data" in b
            ? AGO.Panel.set(b.tab, "data", b.data)
            : (b.data = AGO.Panel.Get(b.tab, "data", 6)));
        ...
        if (AGO.Panel.enabled && DOM.getChildren(d, 2)) {
          ...
          OBJ.iterate(AGO.Panel.Data, function(a) {
            var d;
            AGO.Panel.Get(a, "label", 6) &&
              ((d = AGO.Panel.Get(a, "status")) &&
                "Settings" !== a &&
                "Settings" !== b.tab &&
                a !== b.tab &&
                ((d = 0), AGO.Panel.set(a, "status", d)),
              DOM.updateClass(
                "ago_panel_" + a,
                "id",
                d ? "ago_panel_tab_open" : ""
              ));
          });
          if ("Settings" !== b.tab)
        ...
        AGO.Panel.Get("Settings", "status") &&
          AGO.Panel.createSettings(
            document.getElementById("ago_panel_Settings"),
            b.tab,
            b.data
          );
      }
  ...
  updateTab: function(a) {
    ...
    AGO.Init.status &&
      ((a = OBJ.get(a, "tab")),
      (a && "Flights" !== a) ||
        ((a = AGO.Fleet.Get("Current", "fleets")),
        (b = AGO.Fleet.Get("Current", "fleetsSlots")) &&
          DOM.updateText(
            "#ago_panel_Flights .ago_panel_tab_info",
            null,
            a + "/" + b
          )));
  },
  createSettings: function(a, b, d, c) {
    function e(a, b, d, c, e, f, t, y) {
      ...
      b = AGO.Label.get(b || a);
      d = DOM.appendTR(g, e ? "ago_panel_content_disabled" : "", {
        setting: { id: a },
        update: d,
        message: c
      });
      ...
      b = DOM.appendTD(d);
      b = DOM.append(b, "input", { type: t || "checkbox" }, null, {
        change: AGO.Panel.changeSetting
      });
      "radio" === t
        ? ((b.name = "ago_panel_settings_" + a),
          (b.checked = w === y),
          (b.value = y))
        : "text" === t
          ? (b.value = w || "")
      ...
      b &&
        ...
        (t =
          b.length > h / 7
            ...
            : null),
        (DOM.appendTD(f, t).innerHTML = "&bull;&thinsp;" + b),
        DOM.appendTD(f));
      f = DOM.appendTR(g, "ago_panel_settings_select", {
        setting: { id: a },
        update: d,
        message: c
      });
      a = DOM.appendTD(f, { colspan: 2 });
      DOM.appendSELECT(a, "dropdownInitialized", e, STR.zero(y), {
        change: AGO.Panel.changeSetting
      });
    }
    ...
    if (c)
      ...
      switch (AGO.App.page) {
        ...
        case "movement":
          ...
          break;
        case "messages":
          e("M51", "", "", { page: "Page", role: "toggleSpiohelper" }),
            e("M53"),
            f(
              "M30",
              "M30",
              ...
              { 0: " - ", 1: "M31", 2: "M32", 3: "M33", 4: "M34", 5: "M35" }
            );
      }
  ...
  changeSetting: function(a) {
    ...
    a &&
      a.currentTarget &&
      ((b = DOM.getData(a.currentTarget, null, 2)),
      OBJ.is(b.setting) &&
        ((a =
          "checkbox" !== a.currentTarget.type
            ? +a.currentTarget.value || 0
            : a.currentTarget.checked
              ? 1
              : 0),
        AGO.Option.set(b.setting.id, a, 2),
        OBJ.is(b.update) && AGO.Panel.Display(b.update),
        OBJ.is(b.message) &&
          ("data" in b.message || (b.message.data = a),
          AGO.Init.Messages(b.message.page, b.message.role, b.message.data))));
  },
  createAccount: function(a, b, d) {
    var c, e;
    d && AGO.Option.set("I21", 0, 2);
    2 === AGO.Option.get("I21", 2)
      ? (c = "account")
      : ((c = AGO.Planets.GetId(d) || AGO.Planets.GetId("active")),
        AGO.Option.is("I22") &&
          (e =
            AGO.Planets.Get(c, "moon", 6) || AGO.Planets.Get(c, "planet", 6)));
    AGB.message("Panel", "ListAccount", { planet: c, moon: e }, function(c) {
      ...
      c &&
        ...
        (t =
          2 === AGO.Option.get("I21", 2)
            ? "account"
            : AGO.Planets.GetId(d) || AGO.Planets.GetId("active")),
        (y =
          "account" === t
            ? "account"
            : AGO.Planets.Get(
                t,
                AGO.Option.is("I22") ? "coords" : "coordstype",
                6
              )),
        ...
        AGO.Planets.iterate(1, function(a, d) {
          ...
          m =
            9 <= a.coords.length
              ? "ago_panel_overview_coords_small"
              : "ago_panel_overview_coords";
          DOM.appendTD(p, m, a.coords);
          DOM.appendTD(p, "ago_panel_overview_name", a.name);
          k = DOM.appendTD(p, "ago_panel_overview_status");
          DOM.appendSPAN(k).style.backgroundColor =
            c.statusColor[d] || "#6A0A0A";
          q &&
            (DOM.setData(k, null, {
              tab: b,
            ...
            (DOM.appendSPAN(k).style.backgroundColor =
              c.statusColor[q] || "#6A0A0A"),
            DOM.appendIMG(k, AGO.Planets.Data[q].img));
        }),
        (n = AGO.Events.calculate("ownership")),
        (l = n[y] ? n[y].own : null),
        (n = n[y] ? n[y].neutral : null),
        l &&
          AGO.Option.is("I24") &&
  ...
  appendUnits: function(a, b, d, c, e, f, g, h) {
    function p(a, b, d, c, e) {
      ...
      0 < e
        ? DOM.appendSPAN(a, "ago_panel_content_value", c, 3)
        : ((d = 0 > e ? "I0E" : "I0A"),
          DOM.appendSPAN(
            a,
            {
              class:
                "tooltip ago_panel_content_value ago_panel_content_unavailable",
    ...
    function k(a, b, d, c) {
      for (var e in d)
        if (b[e] || c)
          (d = DOM.appendLI(a, "", e, 11)),
            DOM.appendSPAN(d, "ago_panel_content_value", b[e], 2);
    }
    ...
    if (b) {
      ...
      m = q
        ...
        : "ago_panel_content_header ago_panel_content_disabled";
      m = h ? m + " " + h : m;
      f &&
        (2 <= f || b.resources || b.timeShip) &&
        ((l = p(n, m, d, b.resources, b.timeResource)),
        "string" === typeof c &&
          (DOM.setData(l, null, {
            setting: { id: c },
            update: { tab: e }
      ...
      if (g && q) {
        if (2 <= g || b.shipsCivil)
          (l = p(n, m, "I28", b.shipsCivil, b.timeShip)),
            b.shipsCivil && k(n, b, AGO.Item.ShipCivil);
        if (2 <= g || b.shipsCombat)
          (l = p(n, m, "I29", b.shipsCombat, b.timeShip)),
            b.shipsCombat && k(n, b, AGO.Item.ShipCombat);
      }
      l && a.appendChild(n);
    }
    n = l = null;
  ...
  createFlights: function(a, b, d) {
    function c(a, b, d) {
      DOM.appendSPAN(
        a,
        OBJ.get(AGO.Styles.classFleet, d),
        b && b.fleets ? b.fleets : "\u2009\u2009"
      );
    }
    ...
    f = DOM.appendTABLE(
      ...
      "ago_panel_overview",
      { width: AGO.Panel.innerWidth + "px" },
      [58, AGO.Panel.innerWidth - 130, 72]
    );
    k = AGO.Events.calculate("flights");
    if (k.account) {
      if (
        ((q = 2 !== AGO.Option.get("I41", 2) && AGO.Option.is("I42")),
        (d = k[d] ? d : ""),
        (m =
          2 === AGO.Option.get("I41", 2)
            ? "account"
            : AGO.Planets.Get(d || "active", "coordstype", 6) || d),
        (l = "account" === m ? "account" : q ? AGO.Task.cutCoords(m) : m),
        AGO.Planets.iterate(0, function(a) {
          if ((p = k[a.coordstype]))
            (n =
              l === a.coords || m === a.coordstype
                ? HTML.classType(a.type)
                : ""),
              (g = DOM.appendTR(f, n, {
                tab: b,
                data: a.coordstype
              ...
              (n =
                9 <= a.coords.length
                  ? "ago_panel_overview_coords_small"
                  : "ago_panel_overview_coords"),
              (h = DOM.appendTD(g, n, a.coords)),
              (n =
                m === a.coordstype
                  ? "ago_panel_overview_name"
                  : "ago_panel_overview_name ago_color_normal"),
              (h = DOM.appendTD(g, n)),
              3 === a.type && DOM.appendIMG(h, a.img, "11px"),
              DOM.appendTEXT(h, a.name),
              (h = DOM.appendTD(g, "ago_panel_fleets")),
              c(h, p.hostile, 1),
              c(h, p.neutral, 2),
              c(h, p.back, 4),
              c(h, p.own, 3);
        ...
        if ("account" === l || q)
          (g = DOM.append(e, "ul", "ago_panel_content")),
            (h = DOM.appendLI(g, "ago_panel_content_header", "I47", 10)),
            (d = DOM.appendSPAN(h, "ago_panel_content_value ago_panel_fleets")),
            c(d, k[l].hostile, 1),
            c(d, k[l].neutral, 2),
            c(d, k[l].back, 4),
            c(d, k[l].own, 3),
  ...
  createConstruction: function(a, b, d, c) {
    ...
    function f(a, b, d, c, e, f, g, p) {
      ...
      for (n in AGO.Item.Resource)
        if (0 < k[n] || !k.resources)
          (m[n] = b ? +b[n] || 0 : 0), (m.resources += m[n]);
      if (e || m.resources)
        if (
          ((e = "string" === typeof c ? AGO.Option.is(c) : c),
          d &&
            ((l = e
              ? "ago_panel_content_header"
              : "ago_panel_content_header ago_panel_content_disabled"),
            (d = DOM.appendLI(a, p ? l + " " + p : l, d, 10)),
            (p =
              b && b.timeResource
                ? DOM.appendSPAN(d, "ago_panel_content_value", m.resources, 3)
                : DOM.appendSPAN(
                    d,
                    {
                      class:
          ...
          for (n in AGO.Item.Resource)
            m[n] &&
              (e && f && (h[n] = Math.max(h[n] - (m[n] || 0), 0)),
              (l = e ? "" : "ago_panel_content_disabled"),
              (d = DOM.appendLI(a, l, n, 11)),
              (l = g
                ? 0 < h[n]
                  ? "ago_panel_content_value ago_color_palered"
                  : "ago_panel_content_value ago_color_lightgreen"
                : "ago_panel_content_value"),
              DOM.appendSPAN(d, l, m[n], 2));
    }
    ...
    t
      ? (c.planet = "account")
      : ((c.planet = AGO.Planets.GetId(l)),
        AGO.Option.is("I32") &&
          (c.moon =
            AGO.Planets.Get(c.planet, "moon", 6) ||
            AGO.Planets.Get(c.planet, "planet", 6)));
        ...
        if (OBJ.is(E[z]))
          for (C = 0; C < E[z].length; C++)
            if (((v = ""), (r = E[z][C]))) {
                ...
                if (
                  ...
                  OBJ.iterate(AGO.Item.Resource, function(a) {
                    if (r[a])
                      ...
                      else if (r.selected || q) k[a] += r[a];
                  }),
                  (v = r.reserved ? "ago_color_reserved" : ""),
                  r.selected || q)
                )
                  k.count++, (v = v || HTML.classType(a.type));
              u = DOM.appendTR(s, v, { tab: b, data: a.coordstype + ":" + C });
              ...
              v =
                200 > r.id
                  ? "ago_panel_overview_count " + HTML.classStatus(r.increase)
                  : "ago_panel_overview_count ago_color_normal";
              A = DOM.appendTD(u, v);
              r.reserved &&
                ((B =
                  0 > r.increase
                    ? "icon_reserved_red.gif"
                    : "icon_reserved.gif"),
                DOM.appendIMG(A, HTML.urlImage(B), "11px"));
              DOM.appendTEXT(A, e(r));
            }
      });
      k.count &&
        (AGO.Task.updateResources(k),
        AGO.Task.updateResources(n),
        (h = OBJ.create(k)),
        (s = DOM.append(w, "ul", "ago_panel_content")),
        (v = k.reserved
          ? "ago_panel_content_action ago_panel_content_reserved"
          : "ago_panel_content_action"),
        (u = DOM.appendLI(s, v)),
        (v = 0 > k.increase ? "ago_icon_reserved_red" : "ago_icon_reserved"),
        DOM.appendA(u, v, null, {
          action: {
            action: "reserve",
            tab: b,
            value: d
        ...
        (v = 200 > k.id ? HTML.classStatus(k.increase) : "ago_color_normal"),
        DOM.appendSPAN(u, v, e(k)),
        DOM.appendA(u, "icon icon_fastforward", null, {
          action: {
            action: "increase",
            tab: b,
            value: d
        ...
        (g = AGO.Events.calculate("ownership")),
        (z = t ? "account" : m),
        (x = g[z] && OBJ.is(g[z].own) ? g[z].own : {}),
        (x.timeResource = g.account ? 1 : 0),
        f(s, x, "I24", "I34", "", "reduce", "colorize", "ago_color_own"),
        (x = g[z] && OBJ.is(g[z].neutral) ? g[z].neutral : {}),
        (x.timeResource = g.account ? 1 : 0),
        f(s, x, "I26", "I36", "", "reduce", "colorize", "ago_color_neutral"),
        f(s, n, "I37", "I37", "", "reduce", "colorize", "ago_color_reserved"),
        l === AGO.Acc.coordstype ||
          t ||
          ((s = DOM.append(w, "ul", "ago_panel_content")),
          (x = c.Active || {}),
          AGO.Option.is("I38") &&
          ...
          f(s, x, "I38", "I38", "always", "reduce", "colorize"),
          (v = p.mode
            ? "ago_panel_content_header"
            : "ago_panel_content_header ago_panel_content_disabled"),
          (u = DOM.appendLI(s, v)),
          (B = AGO.Uni.path + "fleet1"),
          OBJ.iterateFilter(
            p,
            function(a) {
          ...
          DOM.appendTEXT(D, "F60", 10),
          DOM.appendSPAN(u, "ago_panel_content_value", p.resources, 2),
  ...
  createAlliance: function(a, b, d, c) {
    function e(b) {
      ...
      b &&
        b.tab &&
        ((e = AGO.Panel.GetActive("Alliance", "id", 6)),
        (d = document.createDocumentFragment()),
        (c = AGO.Panel.appendTable(d)),
        AGO.Panel.appendToken(c, "Alliance", b.token, b.listTab),
        (c = AGO.Panel.appendTable(d)),
        AGO.Panel.appendAlliance(c, "Alliance", b.token, e, b.listToken),
        DOM.replaceChildren(DOM.getChildren(a, 2), d));
    }

    OBJ.get(c, "tab") === b
      ? e(c)
      : AGB.message("Token", "List", { tab: b, token: +d || 0 }, e);
  },
  createPlayer: function(a, b, d, c) {
    function e(b) {
      ...
      b &&
        b.tab &&
        ((e = AGO.Panel.GetActive("Player", "id", 6)),
        (d = document.createDocumentFragment()),
        (c = AGO.Panel.appendTable(d)),
        AGO.Panel.appendToken(c, b.tab, b.token, b.listTab),
        (c = AGO.Panel.appendTable(d)),
        AGO.Panel.appendPlayer(c, b.token, e, b.listToken),
        DOM.replaceChildren(DOM.getChildren(a, 2), d));
    }

    "Player" === OBJ.get(c, "tab")
      ? e(c)
      : AGB.message(
          "Token",
          "List",
  ...
  createTarget: function(a, b, d, c) {
    function e(b) {
      ...
      b &&
        b.tab &&
        ((e = AGO.Panel.GetActive("Target", "id", 6)),
        (d = document.createDocumentFragment()),
        (c = AGO.Panel.appendTable(d)),
        AGO.Panel.appendToken(c, "Target", b.token, b.listTab),
        (c = AGO.Panel.appendTable(d)),
        AGO.Panel.appendTarget(c, b.token, e, b.listToken),
        DOM.replaceChildren(DOM.getChildren(a, 2), d));
    }
    ...
    (f = DOM.getChildren(a, 3)) &&
      0 === DOM.hasChildren(f) &&
      ((g = DOM.appendTABLE(null, "ago_panel_settings", {
        width: AGO.Panel.innerWidth + "px"
      })),
      (h = DOM.appendTR(g)),
      (h = DOM.appendTD(h)),
      DOM.append(
        ...
        null,
        { dblclick: AGO.Panel.parseTarget, blur: AGO.Panel.parseTarget }
      ),
      f.appendChild(g));
    OBJ.get(c, "tab") === b
      ? e(c)
  ...
  appendToken: function(a, b, d, c) {
    ...
    OBJ.iterate(c, function(f) {
      ...
      0 < c[f] &&
        ((h = +f === d ? HTML.classType(1) : ""),
        (g = {
          tab: b,
          data: f
        }),
        (g = DOM.appendTR(a, h, g)),
        DOM.appendTD(g, "ago_panel_overview_coords"),
        DOM.appendTD(
          g,
          "ago_panel_overview_name " + AGO.Token.getClass(f),
          AGO.Token.getLabel(f)
        ),
        DOM.appendTD(g, "ago_panel_overview_count", Math.max(c[f], 0)));
    });
  ...
  appendAlliance: function(a, b, d, c, e) {
    ...
    DOM.appendA(f, "icon icon_delete", "", {
      action: { action: "icon", tab: "Alliance", icon: "remove" }
    });
    OBJ.iterateArray(e, function(e) {
      if (OBJ.is(e)) {
        ...
        "remove" === AGO.Panel.Get("Alliance", "icon", 6) &&
          ((f = {
            message: {
              page: "Token",
              role: "Action",
  ...
  appendPlayer: function(a, b, d, c) {
    ...
    DOM.appendA(e, "icon icon_delete", "", {
      action: { action: "icon", tab: "Player", icon: "remove" }
    });
    OBJ.iterateArray(c, function(c) {
      if (OBJ.is(c)) {
        ...
        "remove" === AGO.Panel.Get("Player", "icon", 6) &&
          ((e = {
            message: {
              page: "Token",
              role: "Action",
  ...
  appendTable: function(a) {
    return DOM.appendTABLE(
      a,
      "ago_panel_overview",
      { width: AGO.Panel.innerWidth + "px" },
      [60, AGO.Panel.innerWidth - 85, 25]
    );
  },
  appendTarget: function(a, b, d, c) {
    ...
    DOM.setData(f, null, {
      action: { action: "sort", tab: "Target", value: 0 }
    });
    f = DOM.appendTD(e, "ago_panel_overview_count");
    DOM.appendA(f, "icon icon_delete", "", {
      action: { action: "icon", tab: "Target", icon: "remove" }
    });
    OBJ.iterateArray(c, function(c) {
      if (OBJ.is(c)) {
        var e, f, l;
        ...
        if (
          2 > h ||
          (AGO.Acc.galaxy === +l[0] &&
            NMR.isMinMax(+l[1], AGO.Acc.system - g, AGO.Acc.system + g))
        )
          (l = +l[3] || 1),
            (f = d === c.id ? HTML.classType(l) : ""),
            (e = {
              tab: "Target",
              data: b,
              action: { action: "toggle", tab: "Target", token: b, id: c.id }
            }),
            (e = DOM.appendTR(a, f, e)),
            DOM.appendTD(
              e,
              "ago_panel_overview_coords",
              AGO.Task.cutCoords(c.coords)
            ),
            (f = DOM.appendTD(e, "ago_panel_overview_name")),
            1 < l && DOM.appendIMG(f, HTML.urlTypeIcon(l), "11px"),
            c.time ? DOM.appendTEXT(f, c.time, 17) : DOM.appendTEXT(f, c.name),
            (f = DOM.appendTD(e, "ago_panel_overview_count")),
            "remove" === AGO.Panel.Get("Target", "icon", 6) &&
              ((e = {
                message: {
                  page: "Token",
                  role: "Action",
  ...
  parseTarget: function(a) {
    a &&
      ...
      ("dblclick" === a.type
        ? (a.target.value = "")
        : ((a = AGO.Task.parseTarget(a.target.value)),
          (a.coords || a.time) &&
            AGO.Token.Action({
              action: "set",
              tab: "Target",
        ...
        for (p = 0; p < AGO.Tools.List.length; p++)
          (g = "T" + h + AGO.Tools.List[p]),
            AGO.Option.is(g) &&
              ...
              (DOM.appendA(e, "", null, f).textContent =
                AGO.Option.getPair(g)[0] || AGO.Label.get(g)));
  ...
  Action: function(a) {
    ...
    "Construction" === b
      ...
      : VAL.check(b, "Alliance", "Player", "Target") &&
        ("sort" === a.action
          ...
          : "icon" === a.action
            ...
            : 2 === a.marked || (a.marked && !AGO.Option.is("I82"))
              ...
              : ("toggle" === a.action &&
                  ((a.action =
                    AGO.Panel.GetActive(b, "id", 6) === a.id
                      ? "deselect"
                      : "select"),
                  "Target" === b &&
                    VAL.check(AGO.App.page, "fleet1", "fleet2") &&
                    (a.action = "select")),
                (d = VAL.check(a.action, "remove", "deselect") ? "" : a.id),
                AGB.message(
                  "Token",
                  "Get",
                  {
                  ...
                  function(c) {
                    ...
                    AGO.Panel.Display({ tab: b, data: a.token });
                    d = { arrival: +OBJ.get(c, "time") || 0 };
                    AGO.Task.updateCoordsType(d, OBJ.get(c, "coords"));
                    OBJ.copy(d, a);
                    "Player" === b
                      ? AGO.Init.Messages("Box", "Action", { tab: b })
                      : "Target" === b &&
                        (AGO.Init.Messages("Main", "Display"),
                        AGO.Init.Messages(
    ...
    if (a && a.target) {
      ...
      OBJ.is(b.setting)
        ? "INPUT" !== a.target.nodeName &&
          DOM.click(
            "input",
            "LI" === a.target.nodeName ? a.target : a.target.parentNode
          )
        : (OBJ.is(b.message) &&
            ...
            AGO.Init.Messages(b.message.page, b.message.role, b.message.data)),
          OBJ.is(b.action)
            ? AGO.Panel.Action(b.action)
            : OBJ.is(b.update)
              ? AGO.Panel.Display(b.update)
              : b.tab && AGO.Panel.Display(b),
          "ago_panel_button" === a.target.id ||
          "ago_panel_arrow" === a.target.className
            ? ((a = DOM.getAttribute(
                "ago_panel_button",
                "id",
                "ago_display_status",
  ...
  hover: function(a) {
    ...
    a &&
      a.target &&
      ((b = AGO.Panel.hoverStatus),
      (AGO.Panel.mouseStatus = "mouseover" === a.type),
      AGO.Panel.mouseStatus &&
        ((!AGO.Option.is("I02") &&
          VAL.check("ago_panel_button", a.target.id, a.target.parentNode.id)) ||
          AGO.Panel.panelActive(1),
        (AGO.Panel.hoverStatus =
          2 > AGO.Panel.displayStatus
            ? 1
            : "ago_panel_button" === a.target.id ||
              "ago_panel_arrow" === a.target.className
              ? 1
  ...
  hoverExtern: function(a) {
    AGO.Panel.enabled &&
      2 <= AGO.Panel.displayStatus &&
      (AGO.Panel.mouseStatus = Boolean(a));
  },
  panelActive: function(a) {
    AGO.Panel.displayStatus =
      AGO.Panel.displayStatus ||
      DOM.getAttribute("ago_panel_button", "id", "ago_display_status", 2);
    AGO.Panel.enabled &&
      AGO.Panel.displayStatus < a &&
      (0 >= AGO.Panel.mouseCount &&
        window.setTimeout(AGO.Panel.panelInactive, 500),
      (AGO.Panel.mouseCount = 5),
      (AGO.Panel.displayStatus = a),
      (AGO.Panel.slideLeft = -(
        Math.ceil(Math.max((+document.body.clientWidth || 0) - 1e3, 2) / 2) - 1
      )),
      2 <= a &&
        AGO.Panel.left < AGO.Panel.slideLeft &&
        DOM.updateStyle("ago_panel", "id", "left", AGO.Panel.slideLeft + "px"),
      DOM.updateAttribute(
        "ago_panel_button",
        "id",
        "ago_display_status",
  ...
  panelInactive: function(a) {
    AGO.Panel.enabled &&
      (AGO.Panel.mouseStatus || AGO.Panel.mouseCount--,
      a || (0 >= AGO.Panel.mouseCount && 3 > AGO.Panel.displayStatus)
        ? ((AGO.Panel.displayStatus = 0),
          DOM.updateAttribute(
            "ago_panel_button",
            "id",
            "ago_display_status",
          ...
          DOM.updateStyle("ago_panel", "id", "left", AGO.Panel.left + "px"))
        : 3 > AGO.Panel.displayStatus &&
          window.setTimeout(AGO.Panel.panelInactive, 500));
  }
};
AGO.Box = {
  ...
  Run: function() {
    ...
    AGO.Box.enabled &&
      a &&
      (OBJ.get(AGO.Box.Data.Cache, "tab")
        ? AGO.Box.Show(AGO.Box.Data.Cache)
        : AGO.Box.Display());
  },
  Show: function(a) {
    var b, d, c, e, f, g;
        ...
        if ((e = a.planets[b]))
          (f = AGO.Task.splitCoords(e.coords)),
            ...
            (g =
              ...
              "&position=" +
              f.position),
            (c = e.planetId === a.planetHome ? "ago_box_homeplanet" : ""),
            (c = DOM.appendDIV(d, c)),
            "galaxy" === AGO.App.page
              ? (DOM.appendA(c, null, null, {
                  message: {
                    page: "Page",
                    role: "Action",
                    data: f
            ...
            VAL.check(AGO.App.page, "fleet1", "fleet2", "fleet3")
              ...
              : ((DOM.appendA(c, {
                  href: "index.php?page=fleet1" + g + "&type=1"
                }).textContent =
                  e.planetName),
                e.moonId &&
                  ((c = DOM.appendA(c, {
                    href: "index.php?page=fleet1" + g + "&type=3"
                  })),
                  DOM.appendIMG(c, HTML.urlTypeIcon(3, "a"), "14px")));
      e = a.playerName + "|Planets: " + a.planets.length + "<BR>";
      (b = document.getElementById("ago_box"))
        ? (DOM.setAttribute("ago_box_title", "id", "title", e),
          DOM.setText("ago_box_title", "id", a.playerName),
          DOM.replaceChildren(document.getElementById("ago_box_content"), d),
          DOM.setStyleDisplay(b, null, "block"))
        : d &&
          ((b = DOM.appendDIV(
            null,
            {
          ...
          (c = DOM.appendDIV(b, { id: "ago_box_header" })),
          DOM.appendA(c, "ago_box_icon22 galaxy highlighted", {
            click: AGO.Box.clickGalaxy
          }),
          DOM.appendA(c, "ago_box_icon22 galaxy highlighted", null, {
            task: "home"
          }),
          DOM.appendSPAN(
            c,
          ...
          DOM.appendA(c, "ago_icon_close", null, {
            action: { action: "remove" }
          }),
          (c = DOM.appendDIV(b, { id: "ago_box_content" })),
          c.appendChild(d),
          DOM.appendChild(document.getElementById("toolLinksWrapper"), b),
          DOM.addEvents("ago_box", "id", { click: AGO.Box.click }));
    } else DOM.setStyleDisplay("ago_box", "id");
  },
  Display: function() {
    var a, b;
    a = AGO.Panel.Get("Box", "data", 6);
    ...
    "Player" === a && b
      ? AGB.message("Box", "List", { tab: a, id: b, planets: 1 }, AGO.Box.Show)
      : AGO.Box.Show();
  },
  click: function(a) {
    a &&
      ...
      "home" === a.task &&
        DOM.click("#ago_box_content .ago_box_homeplanet a:first-child"),
      OBJ.is(a.action) && AGO.Box.Action(a.action),
      OBJ.is(a.message) &&
        AGO.Init.Messages(a.message.page, a.message.role, a.message.data));
  },
  Action: function(a) {
    AGO.Box.enabled &&
      OBJ.is(a) &&
      ("remove" === a.action &&
        (AGB.message("Box", "List", { tab: a.tab }), (a.tab = "")),
      AGO.Panel.set("Box", "data", a.tab),
      AGO.Box.Display());
  }
};
AGO.Events = {
  ...
  Run: function() {
    ...
    if ((a = document.getElementById("eventboxContent")))
      (AGO.Events.included = Boolean(document.getElementById("eventListWrap"))),
        AGO.Events.enabled &&
          ((b =
            !AGO.Events.included && 5 > AGO.Events.modeBehavior
              ? " ago_eventlist_hide"
              : ""),
          DOM.extendClass(a, null, "ago" + b),
          (b = AGO.Events.modeBehavior
            ? VAL.check(AGO.Events.modeBehavior, 2, 4, 6, 8)
              ? 3
              : AGO.Option.is("E34")
                ? 2
                : 1
            : AGO.Events.included
              ? 1
              : 0),
          a.setAttribute("ago_display_status", b),
          AGO.Events.modeBehavior &&
            (DOM.getChildren(a.parentNode, 0) === a
              ? AGO.Events.modeBehaviorAbove || a.parentNode.appendChild(a)
              : AGO.Events.modeBehaviorAbove &&
                DOM.prependChild(a.parentNode, a),
            AGO.Styles.set(
              "#eventboxContent:not(:first-child), #eventboxContent:first-child { display: inherit; }"
            ))),
  ...
  Ready: function() {
    AGO.Events.enabled &&
      AGO.Events.modeBehavior &&
      5 > AGO.Events.modeBehavior &&
      (DOM.setStyleDisplay("eventboxContent", "id"),
      AGO.Styles.set(
        "#eventboxContent, #eventboxContent #eventListWrap { display: block; }"
      ));
  },
  Content: function() {
    var a, b, d, c, e, f, g, h;
    ...
    if (
      ...
      a &&
      b &&
      DOM.updateAttribute(b, null, "ago-status", 1, 8)
    ) {
      AGO.Events.status = 2;
      AGO.Events.enabled &&
        (DOM.removeClass(a, null, "ago_eventlist_hide"),
        (a = b.querySelector("#eventHeader"))) &&
      ...
      for (d = 0; d < a.length; d++)
        (c = NMR.parseIntAbs(a[d].getAttribute("data-mission-type"))),
          HTML.hasClass(a[d].className, "allianceAttack")
            ? ((g = STR.check(NMR.parseIntAbs(a[d].className))),
              (f = "F" + g),
              (h = 1))
            : HTML.hasClass(a[d].className, "partnerInfo")
              ? ((g = STR.check(NMR.parseIntAbs(a[d].className))),
                (f = DOM.getAttribute(
                  ".icon_movement span",
                  a[d],
          ...
          1 !== h &&
            ...
            3 <= AGO.Events.eData[f].fleetType &&
              1 !== h &&
              4 !== c &&
              (AGO.Events.eData[f].pair = AGO.Events.eData[f].reverse
                ? AGO.Events.eData[f - 1]
                  ? AGO.Events.eData[f - 1].pair
                  : ""
                : (5 === c || 15 === c) &&
                  AGO.Events.eData[f - 1] &&
                  AGO.Events.eData[f - 1].pair
      ...
      for (f in AGO.Events.eData)
        AGO.Events.eData.hasOwnProperty(f) &&
          (1 === AGO.Events.eData[f].unionType &&
            (AGO.Task.updateShips(AGO.Events.eData[f]),
            AGO.Task.updateResources(AGO.Events.eData[f]),
            AGO.Events.improve &&
              AGO.Events.createDetails(
                b.querySelector(
                  "table#eventContent tr.union" + AGO.Events.eData[f].union
                ),
                AGO.Events.eData[f]
              )),
    ...
    DOM.iterateChildren(a, function(a) {
      ...
      if (HTML.hasClass(c, "countDown"))
        DOM.addClass(a, null, HTML.classMission(b.mission)),
          ...
          (b.fleetType = HTML.hasClass(c, "neutral")
            ? 2
            : HTML.hasClass(c, "hostile")
              ? 1
              : b.reverse
                ? 4
                : 3);
        ...
        if ((c = a.querySelector("span")) && 1 !== b.unionType) {
          ...
          if (a)
            for (
              a = a.split("<td>"),
                2 <= b.unionType &&
                  AGO.Events.eData["F" + b.union] &&
                  (AGO.Events.eData["F" + b.union].fleets =
                    (AGO.Events.eData["F" + b.union].fleets || 0) + 1),
                c = 1;
              c < a.length;
              c++
            )
              if (
                ((e = (a[c].split("</td>", 1)[0] || "")
                  .replace(/\:/g, "")
                  .trim()),
                (e = AGO.Item.getByName(e)))
              )
                (b[e] = NMR.parseIntAbs(a[c].split(">", 3)[2])),
                  b[e] &&
                    2 <= b.unionType &&
                    AGO.Events.eData["F" + b.union] &&
                    (AGO.Events.eData["F" + b.union][e] =
                      (AGO.Events.eData["F" + b.union][e] || 0) + b[e]);
        }
        ...
        if ((c = a.querySelector("a")))
          (b.coords = AGO.Task.trimCoords(c.textContent)),
            ...
            b.owncoords &&
              ...
              3 <= b.owncoords &&
                DOM.extendClass(a, null, AGO.Token.getClassHighlight(b.type)));
      } else
        HTML.hasClass(c, "sendMail") &&
          (b.nick = DOM.getAttribute(
            DOM.getChildnodeByName(a, "A"),
            null,
            "data-player-name",
            7
          ));
  ...
  createDetails: function(a, b) {
    ...
    1 === b.unionType &&
      b.fleets &&
      DOM.setText(".originFleet", a, b.fleets + " / 16");
    ...
    3 > b.fleetType
      ? DOM.appendIMG(
          ...
          1 === b.fleetType
            ? "/cdn/img/galaxy/activity15.gif"
            : "/cdn/img/galaxy/activity.gif",
          "14px"
        )
      : (d.textContent = b.pair || "");
    ...
    b.nick &&
      !b.owncoordsOrigin &&
      DOM.appendSPAN(e, "ago_eventlist_player", b.nick);
    ...
    (function(a, b) {
      function c(a, b, d, e) {
        ...
        b &&
          d &&
          (DOM.appendSPAN(a, "ago_eventlist_label", b, e),
          DOM.appendTEXT(a, d, 2));
      }
      ...
      for (m = 0; 9 > m; m++)
        if (l.ShipCivil[m] || l.ShipCombat[m] || l.Resource[m])
          (e = DOM.appendTR(d)),
            c(e, l.ShipCivil[m], b[l.ShipCivil[m]], n),
            c(e, l.ShipCombat[m], b[l.ShipCombat[m]], n),
            c(e, l.Resource[m], b[l.Resource[m]], n);
        else break;
      d = e = null;
    })(e, b);
  ...
  toggleEvents: function(a) {
    !a.target ||
      ("H4" !== a.target.nodeName &&
        "ago_display_arrow" !== a.target.className) ||
      ((a =
        DOM.getAttribute("eventboxContent", "id", "ago_display_status", 2) + 1),
      DOM.setAttribute(
        "eventboxContent",
        "id",
        "ago_display_status",
  ...
  clickRow: function(a) {
    ...
    a &&
      a.target &&
      HTML.hasClass(a.target.className, "countDown") &&
      (b = NMR.parseIntAbs(a.target.id)) &&
      AGO.Events.eData[b] &&
      ((a = {
        action: "set",
        tab: "Target",
      ...
      (a.coords = AGO.Events.eData[b].reverse
        ? AGO.Events.eData[b].coordsOrigin +
          ":" +
          AGO.Events.eData[b].typeOrigin
        : AGO.Events.eData[b].coords + ":" + AGO.Events.eData[b].type),
      AGO.Init.Messages("Token", "Action", a));
  },
  displayPair: function(a) {
    ...
    (b = document.getElementById("eventboxContent")) &&
      ...
      ("mouseover" === a.type
        ? DOM.iterate(
            b.querySelectorAll(
              '.eventFleet[ago-events-pair="' +
                d +
                '"], .ago_eventlist[ago-events-pair="' +
                d +
                '"]'
            ),
            function(a) {
        ...
        : DOM.iterate(
            b.querySelectorAll(".eventFleet, .ago_eventlist"),
            function(a) {
  ...
  displayHighlight: function(a) {
    AGO.Events.highlightCurrent = a || 0;
  },
  calculate: function(a) {
      ...
      if (!e || "ships" === e) {
        for (g in AGO.Item.Ship)
          a[g] &&
            (f(g, a[g], b, c, d),
            f("ships", a[g], b, c, d),
            g in AGO.Item.ShipCivil && f("shipsCivil", a[g], b, c, d),
            g in AGO.Item.ShipCombat && f("shipsCombat", a[g], b, c, d));
        f("fleets", 1, b, c, d);
      }
    }
    ...
    if (2 <= AGO.Events.status)
      for (f in ((c.account = {}), AGO.Events.eData))
        0 < +f &&
          ((e = AGO.Events.eData[f]),
          "ownership" === a
            ? e.reverse
              ? ((k = "own"),
                (h = e.coordsOrigin),
                (g = e.coordsOrigin + ":" + e.typeOrigin),
                (p = e.typeOrigin),
                d(e, b(c, "account", k), b(c, h, k), b(c, g, k), "ships"),
                3 === e.mission &&
                  e.pair &&
                  ((h = e.coords), (g = e.coords + ":" + e.type), (p = e.type)),
                d(e, b(c, "account", k), b(c, h, k), b(c, g, k), "resources"))
              : ((h = e.coords),
                (g = e.coords + ":" + e.type),
                (p = e.type),
                (k =
                  2 === e.fleetType && 3 === e.mission
                    ? "neutral"
                    : 3 <= e.fleetType && 4 === e.mission
                      ? "own"
