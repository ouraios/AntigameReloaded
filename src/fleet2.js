AGO.Fleet2 = {
    ...
    if ((b = document.getElementById("inhalt")) && AGO.Option.is("F00")) {
      ...
      DOM.iterate(
        ...
        function(b) {
          ...
          (c = STR.trim(b.name)) &&
            "union" !== c &&
            ((e = NMR.parseIntAbs(c)), (a[200 < e ? e : c] = +b.value || 0));
        }
      );
      b = b.querySelectorAll("#fleetStatusBar li");
      3 <= b.length &&
        ((c = STR.trim(DOM.getText(b[1], null).split("]")[1])),
        (a.planetName = 1 === a.type ? c : ""),
        (a.moonName = 3 === a.type ? c : ""),
        (a.playerHonor = AGO.Ogame.getPlayerHonor(
          DOM.getAttribute("span.honorRank", b[2], "class")
        )),
        (a.playerStatus =
          AGO.Token.getPlayerStatus('span[class^="status_abbr"]', b[2]) || 21),
        (a.playerName = STR.trim(DOM.getText(b[2], null).split(":")[1])));
  ...
  Ready: function() {
    ...
    PAGE.enabled &&
      (0 < a.union
        ...
        : PAGE.Display(),
      DOM.addEvents("speedLinks", "id", {
        click: PAGE.onSpeed,
        mouseover: PAGE.onSpeed,
        mouseout: PAGE.onSpeed
      }),
      DOM.addEvents("#planet h2", null, {
        click: PAGE.onSummary
      }),
      DOM.addEvents("back", "id", {
        click: PAGE.Back
      }),
      DOM.addEventsAll("#galaxy, #system, #position", null, {
        blur: PAGE.onCoords
      }),
      DOM.addEvents("ago_fleet_marked", "id", {
        click: PAGE.onMarked
      }),
      DOM.addEventsAll(
        "#contentWrapper .dropdown.combatunits a, #contentWrapper .dropdown.planets a",
        null,
        {
          click: PAGE.onDropDown
        }
      ));
  },
  Timer: function() {
  ...
  Show: function() {
    ...
    if ((a = document.querySelector("#contentWrapper > form"))) {
      DOM.extendClass(a, null, "ago ago_improve");
      PAGE.showSummary();
      DOM.prependChild(
        a.querySelector("#shortcuts"),
        DOM.appendDIV(null, {
          id: "ago_fleet_player",
          class: "planetname"
        })
      ...
      if ((c = a.querySelector(".briefing h2")))
        (b = document.createDocumentFragment()),
          ...
          DOM.appendSPAN(d, "ago_fleet_count"),
          DOM.appendSPAN(d, "ago_fleet_arrival"),
          DOM.replaceChildren(c, b);
      if ((c = a.querySelector("#duration")))
        (d = DOM.appendLI(
          null,
          "",
          DOM.getTextChild(c.parentNode).split("(")[0] + ":"
        )),
          DOM.appendSPAN(d, {
            class: "value",
      ...
      if ((a = a.querySelector("#continue > span")))
        (b = DOM.appendTABLE(null, "ago_fleet_continue_task", {
          width: "100%"
        })),
          (c = DOM.appendTR(b)),
          (DOM.appendTD(c, {
            id: "ago_fleet_continue_1_coord"
          }).style.width =
            "54px"),
          (d = c.appendChild(document.createElement("td"))),
          (DOM.appendIMG(d, "/cdn/img/layout/pixel.gif", "14px").id =
            "ago_fleet_continue_1_type"),
          (d = c.appendChild(document.createElement("td"))),
          (DOM.appendIMG(d, "/cdn/img/layout/pixel.gif", "17px").id =
            "ago_fleet_continue_1_mission"),
  ...
  showSummary: function() {
    ...
    if ((b = document.getElementById("planet"))) {
      ...
      d = DOM.appendTD(
        e,
        {
          id: "ago_summary_routine"
        },
        PAGE.routine[PAGE.Para.routine],
        10
      );
      d = DOM.appendTD(e, {
        colspan: 2
      ...
      DOM.appendSPAN(
        d,
        {
          id: "ago_summary_civil"
        },
        PAGE.Para.shipsCivil,
        3
      );
      ...
      DOM.appendSPAN(
        d,
        {
          id: "ago_summary_combat"
        },
        PAGE.Para.shipsCombat,
        3
      );
      g = {
        Resource: [],
      ...
      OBJ.iterate(g, function(a) {
        OBJ.iterate(AGO.Item[a], function(b) {
      ...
      for (h = 0; 9 > h; h++)
        if (g.Resource[h] || g.ShipCivil[h] || g.ShipCombat[h])
          (e = DOM.appendTR(f)),
            (d = DOM.appendTD(e, null, g.Resource[h], 11)),
            DOM.appendSPAN(d, null, PAGE.Para[g.Resource[h]], 2),
            (d = DOM.appendTD(e, null, g.ShipCivil[h], 11)),
            DOM.appendSPAN(d, null, PAGE.Para[g.ShipCivil[h]], 2),
            (d = DOM.appendTD(e, null, g.ShipCombat[h], 11)),
            DOM.appendSPAN(d, null, PAGE.Para[g.ShipCombat[h]], 2);
        else break;
      b.appendChild(c);
    }
  ...
  showShortcuts: function() {
    function a(a, b, c) {
      ...
      DOM.appendIMG(d, HTML.urlTypeIcon(b.type), "14px");
      d = a.appendChild(document.createElement("span"));
      d.className = "ago_shortcuts_icon";
      ...
      c &&
        ((d = a.appendChild(document.createElement("span"))),
        (d.className = "ago_shortcuts_name"),
        (d.textContent = c));
    }
    ...
    if ((b = document.getElementById("inhalt"))) {
      ...
      e = DOM.appendTD(f, "");
      DOM.appendSPAN(e, "ago_shortcuts_description", "F40", 10);
      c = "F41 F42 F43 F44 F45 F46 F47 F48 F49".split(" ");
      for (h = 0; h < c.length; h++)
        (g = AGO.Option.get(c[h], -1)) && a(e, AGO.Task.splitActive(g, 0, 4));
      c = document.getElementById("aksbox");
      1 < DOM.hasChildren(c) &&
        (DOM.appendSPAN(
          e,
          "ago_shortcuts_description",
          DOM.getText('#shortcuts span[id^="combatunits"]', b)
        ),
        DOM.iterateChildren(c, function(b) {
          var c;
          c = (b.value || "").split("#");
          3 < c.length &&
            ((c = [c[0], c[1], c[2], c[3], 2, 0, 0, 0, c[5]].join(":")),
            a(e, AGO.Task.split(c, 0, 4), b.textContent));
        }));
      e = DOM.appendTD(f, "ago_shortcuts_spacer");
      ...
      DOM.appendSPAN(
        e,
        "ago_shortcuts_description",
        DOM.getText('#shortcuts span[id^="shortlinks"]', b)
      );
      AGO.Planets.iterate(1, function(a) {
        ...
        if ((a = AGO.Planets.Data[a.moon]))
          DOM.appendIMG(c, a.img || HTML.urlTypeIcon(3), "18px"),
            DOM.appendTEXT(c, a.name);
  ...
  Display: function() {
    ...
    b = PAGE.Next;
    if (
      (d = document.querySelector("#contentWrapper > form")) &&
      7 <= AGO.Init.status
    ) {
      if ((f = d.querySelector("#duration")))
        f.textContent = (f.textContent || "").split(" ")[0];
      PAGE.Next.duration =
        +AGO.Global.message({
          role: "getProperty",
          property: "duration"
      ...
      DOM.setText(
        "ago_fleet_duration_return",
        "id",
        2 * PAGE.Next.duration,
        18
      );
      if (!PAGE.updateDisplaySpeed) {
        ...
        if ((f = d.querySelector("#speed")))
          (g = Math.min(b.speed, b.maxspeed)),
            g !== +f.value &&
              ((f.value = g),
              DOM.iterate(d.querySelectorAll("#speedLinks a"), function(a) {
                DOM.removeClass(a, null, "selected");
              }),
              DOM.addClass("#speedLinks a:nth-child(" + g + ")", d, "selected"),
              AGO.Global.message({
                role: "updateVariablesTimes"
              }));
        ...
        (f = d.querySelector("#aksbox")) &&
          f.options[0] &&
          ((e = b.union
            ? f.querySelector('option[value$="#' + b.union + '"]')
            : null) &&
          -1 <
            (e.value || "").indexOf(
              [b.galaxy, b.system, b.position, g].join("#")
            )
            ? ((b.type = g),
              (b.mission = 2),
              (b.arrivalUnion = +e.getAttribute("data-arrival-time") || 0),
              (b.nameUnion = e.textContent || ""))
            : ((b.union = 0),
              2 === b.mission && (b.mission = PAGE.Para.mission),
              (b.arrivalUnion = 0),
              (f.selectedIndex = 0),
              (e = f.options[0]),
              DOM.setValue('input[name="union"]', d, "0")),
          (f = DOM.updateAttribute(
            ".dropdown.combatunits a",
            f.parentNode,
            "data-value",
            e.value
          )) && DOM.setText(f, null, e.textContent));
        if ((f = d.querySelector("#slbox")))
          (e = [b.galaxy, b.system, b.position, g].join("#")),
            (e = f.querySelector('option[value^="' + e + '"]')) &&
            b.owncoords &&
            2 !== g
              ? ((f.value = e.value), 3 > b.owncoords && (b.type = g))
            ...
            (f = DOM.updateAttribute(
              ...
              DOM.setText(
                f,
                null,
                STR.check(e.getAttribute("data-html-prepend")) +
                  STR.check(e.textContent),
                9
              );
        c = OBJ.create(b);
        g = PAGE.Para.routine || 0;
        if (2 <= g || AGO.Option.is("F51"))
          (c.type = PAGE.Type.check(c.type) || PAGE.Para.type),
            (c.owncoords = AGO.Planets.owncoords(c.coords, c.type)),
            (c.mission = a(c.mission)),
            16 === c.position
              ? ((c.mission = 15),
                (c.type = 1),
                c.owncoords && (c.owncoords = 1),
                VAL.check(g, 7, 6) || (g = 0))
              : 2 === c.type
                ? ((c.mission = 8), VAL.check(g, 4, 6) || (g = 0))
                : c.owncoords &&
                  ((c.type = AGO.Planets.GetByCoords(c.coords, "moon", 6)
                    ? 3 > c.owncoords
                      ? c.type
                      : 1 === AGO.Acc.type
                        ? 3
                ...
                : 4 === g
                  ...
                  : 7 === g
                    ...
                    : 5 === g
                      ? 2 > b.owncoords && (g = 0)
                      : 6 === g &&
                        (c.mission = c.mission || a(PAGE.Para.mission))),
            (b.routine = g),
            (c.mission =
              c.mission ||
              a(PAGE.Para.mission) ||
              a(AGO.Option.is("F54") ? 4 : 3) ||
              a(3) ||
              a(4));
        DOM.setValue('input[name="mission"]', d, c.mission);
        c.type !== DOM.getValue("input#type", d, 2) &&
          AGO.Global.message({
            role: "setType",
            value: c.type
          });
        ...
        DOM.updateAttribute(
          ...
          "id",
          "src",
          HTML.urlTypeIcon(c.type, "b")
        );
        DOM.updateAttribute(
          "ago_fleet_continue_1_mission",
          "id",
          "src",
          HTML.urlMissionIcon(c.mission)
        );
        DOM.updateClass("ago_summary_routine", "id", g ? "on" : "");
  ...
  displayUnion: function() {
    ...
    DOM.hasChildren(b) &&
      (a.displayUnion !== a.arrivalUnion &&
        ((a.displayUnion = a.arrivalUnion),
        DOM.updateText(
          b.children[0],
          null,
          a.nameUnion + " (" + AGO.Label.get("F28") + ")"
        ),
        DOM.updateStyle(b, null, "display", a.arrivalUnion ? "block" : "none"),
        AGO.Init.Messages("Events", "highlight", a.arrivalUnion)),
      a.arrivalUnion &&
        ((c = Math.floor(
          a.arrivalUnion - (AGO.Time.serverTime + AGO.Time.durationRun) / 1e3
        )),
        0 <= c &&
          ((f = Math.floor(a.duration / 130 * 100)),
          (e = Math.floor(1.3 * c)),
          (d = a.arrivalUnion - c + e),
          (f = a.duration < c ? 3 : c > f ? 2 : 0 < c ? 1 : 0),
          DOM.updateText(b.children[1], null, e, 18),
          (a =
            AGO.Time.formatTime(Math.abs(a.duration - e)) +
            " / " +
            AGO.Time.formatTime(Math.abs(c - a.duration))),
          DOM.updateText(b.children[2], null, a),
          DOM.updateStyle(
            b.children[2],
            null,
            "color",
            ["#FF0000", "#D43635", "#FF9600", "#99CC00"][f]
          ),
          DOM.updateText(
            b.children[3],
            null,
  ...
  displayMarked: function() {
    ...
    DOM.hasChildren(b) &&
      (a.displayMarked !== a.arrivalMarked &&
        ((a.arrivalMarked = a.displayMarked =
          1e3 < a.arrivalMarked ? a.arrivalMarked : 0),
        DOM.updateText(
          b.children[0],
          null,
          AGO.Label.get("I80") + ": " + (a.coordsMarked || "")
        ),
        DOM.updateText(
          b.children[3],
          null,
        ...
        DOM.updateStyle(
          ...
          null,
          "display",
          a.arrivalMarked ? "block" : "none"
        )),
      a.arrivalMarked &&
        ((c = Math.floor(
          a.arrivalMarked - (AGO.Time.serverTime + AGO.Time.durationRun) / 1e3
        )),
        (d = DOM.hasClass("continue", "id", "on")
          ? a.duration < c
            ? 3
            : 0 < c
              ? 2
              : 0
          : 1),
        DOM.updateText(b.children[1], null, Math.max(c, 0), 18),
        DOM.updateText(b.children[2], null, Math.abs(c - a.duration), 18),
        DOM.updateStyle(
          b.children[2],
          null,
          "color",
          ["#FF0000", "#D43635", "#FF9600", "#99CC00"][d]
        )));
  },
  displayShortcuts: function(a) {
    var b;
    if ((b = document.getElementById("ago_shortcuts")))
      DOM.iterateChildren(b.querySelector(".ago_shortcuts_own"), function(b) {
        var d, f;
        "A" === b.nodeName &&
  ...
  displayPlayer: function(a) {
    function b(a) {
      ...
      b = PAGE.Next;
      16 === b.position
        ? ((d = AGO.Label.get("LM15")), (k = AGO.Option.get("C15", 20)))
        : b.owncoords
          ? (k = OBJ.get(AGO.Styles.colorType, a))
          : b.coords === PAGE.Para.coords
            ? ((c = HTML.getPlayer(
                PAGE.Para.playerName,
                PAGE.Para.playerStatus,
                PAGE.Para.playerHonor
              )),
              (d = VAL.choose(a, PAGE.Para.planetName, "", PAGE.Para.moonName)))
            : b.coords === b.playerCoords && b.playerId
              ? ((c = HTML.getPlayer(
                  b.playerName,
                  b.playerStatus,
                  b.playerHonor
                )),
                (d = VAL.choose(a, b.planetName, "", b.moonName)))
              : ((c = "?"), (d = 2 === a ? "" : "?"));
    ...
    d = a.type;
    b(d);
    AGO.DataBase.enabled &&
      c.coords !== c.playerCoords &&
      !c.owncoords &&
      ((c.playerCoords = c.coords),
      (c.playerId = 0),
      AGB.message(
        "DataBase",
        "GetPlanet",
  ...
  Action: function(a) {
    ...
    (c = document.querySelector("#contentWrapper > form")) &&
      ...
      a.union &&
        ((d = c.querySelector('#aksbox option[value$="#' + a.union + '"]')) &&
        2 === a.mission
          ? DOM.setValue(d.parentNode, null, d.value, 0, "change")
          : (a.union = 0)),
      a.union ||
        ((d = [a.galaxy, a.system, a.position, a.type].join("#")),
        (d = c.querySelector('#slbox option[value^="' + d + '"]'))
          ? (DOM.setValue(d.parentNode, null, d.value, 0, "change"),
            (b.type = a.type))
          : (a.galaxy && DOM.updateValue("galaxy", "id", a.galaxy, 0, "change"),
            a.system && DOM.updateValue("system", "id", a.system, 0, "change"),
            a.position &&
              DOM.updateValue("position", "id", a.position, 0, "change"),
            a.type &&
              ((b.type = PAGE.Type.check(a.type) || b.type),
              AGO.Global.message({
                role: "setType",
                value: b.type
              }))),
        (b.mission =
          PAGE.Mission.check(a.mission) || b.mission || PAGE.Para.mission)),
      NMR.isMinMax(a.speed, 1, 10) && (b.speed = a.speed),
      PAGE.Display(),
      window.setTimeout(DOM.setFocus, 10, "#continue"));
  },
  clickType: function() {
    var a, b;
    b = DOM.getAttribute("ago_global_data", "id", "ago-data-type", 2);
    a = PAGE.Type.check(b) || PAGE.Next.type;
    a === b
      ? (PAGE.Next.type = a)
      : DOM.setAttribute("ago_global_data", "id", "ago-data-type", "");
  },
  Continue: function() {
    var a;
  ...
  onSummary: function(a) {
    a &&
      ...
      "click" === a.type &&
      a.currentTarget &&
      "H2" === a.target.nodeName &&
      DOM.click("#planet .toggleHeader");
  },
  onMarked: function() {
    PAGE.Action({
      arrival: -1
        ...
        ? "ago_shortcuts_header" === a.currentTarget.className
          ? ((b =
              ...
              DOM.getAttribute("ago_shortcuts", "id", "ago_display_status", 2)
                ? 1
                : 2),
            DOM.setAttribute("ago_shortcuts", "id", "ago_display_status", b, 8),
            AGO.Option.set("F15", 2 !== b, 1))
          : ((b = a.currentTarget.rel || ""),
            DOM.hasClass(
              ...
              (b +=
                ":" +
                ("ago_shortcuts_ownmoon" === d
                  ? 3
                  : "ago_shortcuts_owndebris" === d
                    ? 2
                    : 1))),
            PAGE.Action(AGO.Task.split(b, 0, 4)))
        : "dblclick" === c
          ? AGO.Option.is("U34") && DOM.click("#fleet2 #continue")
          : ("A" === a.target.nodeName
              ? (b = a.target)
              : "SPAN" === a.target.nodeName
                ? ((d = a.target.className), (b = a.target.parentNode))
                : "SPAN" === a.target.parentNode.nodeName &&
                  ((d = a.target.parentNode.className),
  ...
  onCoords: function(a) {
    ...
    a &&
      a.currentTarget &&
      !NMR.parseIntAbs(a.currentTarget.value) &&
      (b = a.currentTarget.getAttribute("ago_value")) &&
      ((a.currentTarget.value = b),
      AGO.Global.message({
        role: "checkOk"
      }),
      PAGE.Display());
  ...
  onDropDown: function(a) {
    if (
      (a = (a = this.getAttribute("rel")) ? document.getElementById(a) : null)
    )
      DOM.iterate(a.querySelectorAll("li a"), function(a) {
        DOM.removeClass(a, null, "focus");
      }),
        DOM.addClass(
          'li a[data-value="' +
            DOM.getAttribute(this, null, "data-value") +
            '"]',
          a,
          "focus"
        );
  ...
  onSpeed: function(a) {
    ...
    b = a && a.target ? a.type : "";
    "click" === b
      ? ((PAGE.updateDisplaySpeed = 0),
        PAGE.Action({
          speed: +a.target.getAttribute("data-value")
        }))
      : "mouseover" === b
        ? (PAGE.updateDisplaySpeed = 2)
        : "mouseout" === b &&
          ((PAGE.updateDisplaySpeed = 1),
          window.setTimeout(function() {
            1 === PAGE.updateDisplaySpeed &&
              ((PAGE.updateDisplaySpeed = 0), PAGE.Display());
          }, 10));
  }
};
