...
AGB.Option = {
  ...
  Messages: function(a, b, c) {
    "Set" === a
      ...
      : "Menu" === a
        ? AGB.Option.Menu(b, c)
        : "Save" === a && AGB.Option.MenuSave(b, c);
  },
  Init: function(a, b) {
    var c, d, e, f, g, h;
    if ((e = AGB.App.getPlayer(a))) {
      ...
      if (c.version) {
        ...
        for (h = 0; h < g.length; h++) c[g[h]] = 1;
        c.version === d.version && OBJ.parseCopy(d, c);
      }
      f = AGB.Option.get(c, "D04");
      f = NMR.isMinMax(f, 1, 3)
        ? f
        : NMR.minMax(AGB.Option.getDefault("D04", 0), 1, 3);
      OBJ.iterate(AGB.Para, function(a) {
        AGB.Para[a][0] &&
          (AGB.Option.set(AGB.Option.Data[e], a, AGB.Option.getDefault(a, f)),
          a in c && AGB.Option.set(AGB.Option.Data[e], a, c[a]));
      });
  ...
  Save: function(a) {
    ...
    AGB.Data.isStatus(c) &&
      ...
      (f = []),
      (g = []),
      (d = { version: AGB.Data.get("Option", "Data", "version") }),
      (e = { version: AGB.Data.get("Option", "Data", "version") }),
      OBJ.iterate(AGB.Para, function(a) {
        AGB.Para[a][1] &&
          (b[a] ? (1 === b[a] ? g.push(a) : (d[a] = b[a])) : f.push(a),
          3 === AGB.Para[a][1] && (e[a] = b[a]));
      }),
      (d.empty = f.join(",")),
      (d.one = g.join(",")),
      a.save &&
        ((a.save[c + "_Option_Data"] = JSON.stringify(d)),
        (a.save[c + "_Option_Local"] = JSON.stringify(e))),
      a.backup &&
        AGB.Data.isBackup(c, "Option", "Data", 2) &&
        (a.backup.Option_Data = JSON.stringify(d)));
  },
  Menu: function(a, b) {
    var c;
    c = AGB.App.getPlayer(a);
    AGB.Data.isStatus(c) &&
      b &&
      b({ Limit: AGB.Option.Limit, Para: AGB.Para, Data: AGB.Option.Data[c] });
  },
  MenuSave: function(a, b) {
    ...
    AGB.Data.isStatus(d) &&
      c &&
      (OBJ.is(a.data) &&
        (OBJ.iterate(AGB.Para, function(b) {
  ...
  Set: function(a, b) {
    ...
    d &&
      c &&
      ((e = AGB.Option.valid(a.id)) && AGB.Para[e] && AGB.Para[e][0]
        ? ((d = AGB.Option.get(c, e)),
          (e = {
            id: e,
  ...
  Get: function(a, b) {
    return (b = AGB.Option.valid(b)) && a && OBJ.is(AGB.Option.Data[a])
      ? AGB.Option.get(AGB.Option.Data[a], b)
      : "";
  },
  set: function(a, b, c) {
    var d;
    ...
    if (a && b && d) {
      if (1 === d) a[b] = c && "0" !== c ? 1 : 0;
      else if (2 === d)
        (c = NMR.parseIntFormat(c)),
          b in AGB.Option.Limit &&
            (c = Math.max(
              Math.min(c, AGB.Option.Limit[b][1]),
              AGB.Option.Limit[b][0]
            )),
          (a[b] = c);
      else if (6 === d) a[b] = AGB.Option.valid(c);
      else if (VAL.check(d, 20, 21, 22, 23)) {
        c = STR.check(c).split("|");
        c[0] = AGB.Option.valid(c[0]);
        c[1] = 21 <= d ? NMR.minMax(+c[1], 0, 100) || "" : "";
        c[2] = 22 <= d ? NMR.minMax(+c[2], 0, 19) || "" : "";
        c[3] = c[2] ? +c[3] || "" : "";
        ...
        if ("|" === c || "0|" === c || "0" === c) c = "";
        a[b] = AGB.Option.valid(c);
      } else -1 === d && (a[b] = AGB.Option.validTask(c));
      return a[b];
    }
  },
  get: function(a, b) {
  ...
  getDefault: function(a, b) {
    ...
    return a && c
      ? ((b = NMR.minMax(AGB.Para[a].length - 3, 0, +b || 0)),
        AGB.Para[a][2 + b] || "")
      : "";
  },
  valid: function(a) {
...
AGB.Label = {
  ...
  Init: function(a, b) {
    ...
    d &&
      ...
      OBJ.parseCopy(
        OBJ.get(b, AGB.Data.getKey(a.keyCom, "Label", "Api")),
        c[d]
      ));
  },
  Load: function(a) {
    var b;
    AGB.App.getPlayer(a, "copy") &&
      ...
      (b.onerror = b.onload = function() {
        ...
        if (d && AGB.Label.Data[d]) {
          if (200 === +b.status && b.responseText)
            for (
              e = STR.check(b.responseText).split("<name"), p = 0;
              p < e.length;
              p++
            )
              if ((f = STR.check(e[p])))
                (c.status = 1),
                  (l = STR.getAttribute(f, "id")),
          ...
          1 === c.status &&
            (OBJ.copy(c, AGB.Label.Data[d]),
            AGB.Item.Init(a),
            AGB.Data.setStorage(a.keyCom, "Label", "Api", c));
          AGB.Core.Log(
            "Update   - Label    : " +
              a.urlUni +
  ...
  Update: function(a) {
    ...
    (c = AGB.App.getPlayer(a)) &&
      ...
      (e =
        OBJ.is(d.timeunits) && d.timeunits["short"]
          ? d.timeunits["short"]
          : {}),
      ...
      (b.KD0M = e.minute || "m"),
      (b.KD0S = e.second || "s"),
      (d = OBJ.is(a.data.production) ? a.data.production : {}),
      (f = {
        metal: "091",
        crystal: "092",
        deuterium: "093",
      ...
      OBJ.iterate(f, function(a) {
        OBJ.is(d[a]) &&
          (b["L" + f[a]] =
            (STR.check(d[a].tooltip).split("|")[0] || "").trim() || a);
      }),
      AGB.Core.Log(
        "Update   - Label    : " +
          b.KU0B +
  ...
  Get: function(a, b, c) {
    return (a = AGB.App.getPlayer(a)) && AGB.Label.Data[a] && b
      ? (c &&
          (b =
            1 === b.length ? "L00" + b : 2 === b.length ? "L0" + b : "L" + b),
        b in AGB.Label.Data[a] ? AGB.Label.Data[a][b] || "" : b)
      : "";
  }
};
AGB.Styles = {
  ...
  Init: function(a, b) {
    function c(a, b) {
      function c(a, e, f, h, m) {
        m || (e && !AGB.Option.Get(d, e))
          ? ((e = ""), (f = 0))
          : ((e = OBJ.get(AGB.App.Page[a], "css") || ""),
            (f = +AGB.Option.Get(d, f) || 0));
        e !== b.Page.file && (b[a] || (b[a] = {}), (b[a].file = e));
        f !== b.Page.improve && (b[a] || (b[a] = {}), (b[a].improve = f));
        b.Events &&
          h &&
          ((h = +AGB.Option.Get(d, h) || 0),
          h !== b.Page.events && (b[a] || (b[a] = {}), (b[a].events = h)));
      }

      var d, e, m, k;
      d = a.keyPlayer;
      b.Main = "main";
      AGB.Option.Get(d, "O50") &&
        (b.Planets = AGB.Option.Get(d, "O51")
          ? "main_planets_improve"
          : "main_planets");
      AGB.Option.Get(d, "E30") &&
        (b.Events = AGB.Option.Get(d, "E31")
          ? "main_events_improve"
          : "main_events");
      a.mobile && (b.Mobile = "ogame_mobile");
      if ((e = AGB.Option.Get(d, "U11")))
        (k = "  middle dark    color".split(" ")[e]),
          (m = AGB.Option.Get(d, "U19")),
          (b.Skin =
            '@import url("' +
            AGB.Config.pathSkin +
            'cache/cache.css");' +
            (k
              ? '@import url("' + AGB.Config.pathSkin + "cache/" + k + '.css");'
              : "") +
            (7 === e && m ? "body { background: " + m + " !important; }" : ""));
      b.Page = {
        file: "pages",
        improve: 0,
        events: +AGB.Option.Get(d, "E49") || 0
      };
    ...
    function d(a, b) {
      ...
      AGB.Option.Get(c, "CM0") &&
        (OBJ.iterate(AGB.Item.Mission, function(a) {
          d.push(
            ".ago_color_" +
              a +
              "{color:" +
              AGB.Option.Get(c, a.replace(/M/, "C")) +
              "!important;}"
          );
        }),
        (m = AGB.Option.Get(c, "CM3")),
        NMR.isMinMax(m, 1, 99) &&
          d.push(
            "#eventContent .ago_events_reverse, #eventContent .ago_events_reverse + .ago_eventlist, #inhalt div.fleetDetails[ago_events_reverse] > span{opacity:" +
              AGB.Styles.getOpacity(m) +
              "!important;}"
          ));
      if (AGB.Option.Get(c, "CT0"))
        for (m = 21; 80 > m; m++)
          (k = AGB.Token.getColor(c, m)) &&
            "INHERIT" !== k &&
            d.push(
              "." + AGB.Token.getClass(c, m) + "{color:" + k + "!important;}"
            );
      ...
      if (AGB.Option.Get(c, "CS0")) {
        (k = AGB.Token.getColor(c, "S5")) &&
          d.push(
            ".ago_selected_S5{box-shadow: 0 0 3px 2px " +
              k +
              ", 0 0 1px 1px " +
              k +
              " inset;}"
        ...
        for (n = 1; 3 >= n; n++)
          if (((m = "S" + n), (k = AGB.Token.getColor(c, m))))
            (e[n] = k),
              d.push(".ago_selection_" + m + "{color:" + k + "!important;}"),
              d.push(
                ".ago_selected_" +
                  m +
              ...
              d.push(
                ".ago_hover_" +
                  ...
                  "_own:hover{color:" +
                  k +
                  "!important;box-shadow: 0 0 1px 0 " +
                  k +
                  " inset;}"
              ),
              AGB.Token.getCondition(c, m) &&
                (d.push(
                  ".ago_highlight_" +
                    m +
                    "{background-color:" +
                ...
                d.push(
                  ".ago_highlight_" +
                    ...
                    AGB.Token.getColorOpacity(c, m, "active") +
                    ";}"
                ));
        if (AGB.Option.Get(c, "O55")) {
          if ((k = AGB.Token.getColor(c, "S1")))
            d.push(
              "#rechts .ago_highlight .planet-name, #rechts .ago_highlight .planet-koords{color:" +
                k +
                "!important;}"
            ),
              d.push(
                "#rechts .smallplanet:hover .planet-name, #rechts .smallplanet:hover .planet-koords{color:" +
                  k +
                  "!important;}"
              );
          if ((k = AGB.Token.getColor(c, "S3")))
            d.push(
              "#rechts .ago_highlight_S3 .planet-name, #rechts .ago_highlight_S3 .planet-koords{color:" +
                k +
                "!important;}"
            ),
              d.push(
                "#rechts .ago_highlight_S3_active .planet-name, #rechts .ago_highlight_S3_active .planet-koords{color:" +
                  k +
                  "!important;}"
              ),
              d.push(
                "#rechts .ago_hover_S3:hover .planet-name, #rechts .ago_hover_S3:hover .planet-koords{color:" +
                  k +
                  "!important;}"
              );
        }
      ...
      for (n = 1; 3 >= n; n++)
        d.push(
          "." + AGB.Styles.classType[n] + "{color:" + e[n] + "!important;}"
        );
      b.colorType = e;
      b.Color = d.join("");
    }
  ...
  getImport: function(a) {
    return a
      ? '@import url("' + AGB.Config.pathSkin + "ago/" + a + '.css");'
      : "";
  },
...
AGB.Item = {
  ...
  Init: function(a) {
    var b, c;
    (c = AGB.App.getPlayer(a)) &&
      1 === +OBJ.get(AGB.Label.Data[c], "status") &&
      ((AGB.Item.Data[c] = {}),
      (b = AGB.Item.Data[c]),
      OBJ.iterate(AGB.Item.Ship, function(c) {
        b[AGB.Label.Get(a, c, 1) || c] = c;
      }),
      OBJ.iterate(AGB.Item.Defense, function(c) {
        b[AGB.Label.Get(a, c, 1) || c] = c;
      }),
...
AGB.Units = {
  ...
  Messages: function(a, b, c) {
    "Action" === a
      ? AGB.Units.Action(b, c)
      : "Update" === a
        ? AGB.Units.Update(b, c)
        : "List" === a && AGB.Units.List(b, c);
  },
  Start: function(a) {
    var b, c;
    c = {};
    (b = AGB.Units.Data[a]) &&
      b.account &&
      ((c.status = b.status),
      (c.timeResearch = AGB.Time.timestampMinuteConvert(
        b.account.timeResearch
      )),
  ...
  Init: function(a, b) {
    ...
    if ((e = AGB.App.getPlayer(a)))
      (AGB.Units.Data[e] = {
        ...
        (c = AGB.Units.Data[e]),
        (c.account = {}),
        (d = OBJ.parse(b[AGB.Data.getKey(e, "Units", "Data")])),
        d.version === f &&
          ((c.status = d.status || 2),
          d.account &&
            ((g = STR.check(d.account).split(",")),
            AGB.Item.Info.timeResearch &&
              (c.account.timeResearch =
                +g[AGB.Item.Info.timeResearch.index] || 0),
            OBJ.iterate(AGB.Item.Research, function(a) {
              AGB.Item.Info[a] &&
                (c.account[a] = +g[AGB.Item.Info[a].index] || 0);
            })),
          OBJ.iterate(d, function(a) {
            if (0 < +a) {
              ...
              OBJ.iterate(AGB.Item.Info, function(d) {
                (100 < +d && 200 > +d) ||
                  "timeResearch" === d ||
                  (c[a][d] = +b[AGB.Item.Info[d].index] || 0);
              });
            }
          })),
  ...
  Save: function(a) {
    ...
    AGB.Data.isStatus(d) &&
      ...
      b.account &&
        ((c = []),
        AGB.Item.Info.timeResearch &&
          (c[AGB.Item.Info.timeResearch.index] = +b.account.timeResearch || ""),
        OBJ.iterate(AGB.Item.Research, function(a) {
      ...
      AGB.Units.iterate(d, function(a, b) {
        ...
        OBJ.iterate(AGB.Item.Info, function(b) {
          (100 < +b && 200 > +b) ||
            "timeResearch" === b ||
            (c[AGB.Item.Info[b].index] = +a[b] || "");
        });
        for (d = c.length; 0 < d && !c[d - 1]; ) d--;
        c.length = d;
        e[b] = c.join(",");
      }),
      a.save && (a.save[d + "_Units_Data"] = JSON.stringify(e)),
      a.backup &&
        AGB.Data.isBackup(d, "Units", "Data", 2) &&
        (a.backup.Units_Data = JSON.stringify(e)));
  },
  Update: function(a, b) {
    var c, d, e;
    d = AGB.App.getPlayer(a);
  ...
  Action: function(a, b) {
    function c(a, b, c, d) {
      var f, k;
      if (("account" === a || 0 < +a) && Array.isArray(b) && OBJ.is(d))
        for (OBJ.is(e[a]) || (e[a] = {}), f = e[a], k = 0; k < b.length; k++)
          (a = b[k]),
            "Resource" === a
              ? (OBJ.iterate(AGB.Item.ResourceEnergy, function(a) {
                  f[a] = +d[a] || 0;
                }),
                (f.resources = f.metal + f.crystal + f.deuterium),
                (f.timeResource = AGB.Time.timestampMinute()))
              : "Ship" === a
                ? ((f.shipsCivil = 0),
                  (f.shipsCombat = 0),
                  ...
                  (f.ships = f.shipsCivil + f.shipsCombat),
                  (f.timeShip = AGB.Time.timestampMinute()))
                : "Research" === a
                  ? (OBJ.iterate(AGB.Item.Research, function(a) {
                      f[a] = +d[a] || 0;
                    }),
                    ...
                    (e.status = 1))
                  : AGB.Item[a] &&
                    (OBJ.iterate(AGB.Item[a], function(a) {
                      f[a] = +d[a] || 0;
                    }),
                    (f["time" + a] = 1));
    }
    ...
    f &&
      ...
      (OBJ.iterateArray(a.list, function(a) {
  ...
  SummarizePosition: function(a) {
    ...
    g &&
      ...
      ((e = d[a.planet] || {}),
      (f = d[a.moon]),
      OBJ.iterate(AGB.Item.Resource, b),
      OBJ.iterate(AGB.Item.Ship, b),
      OBJ.iterate(
        {
          resources: 0,
          ships: 0,
  ...
  iterate: function(a, b) {
    var c, d;
    c = AGB.Units.Data[a];
    if (a && c) for (d in c) c.hasOwnProperty(d) && 0 < +d && b(c[d], d);
  }
};
AGB.Task = {
  ...
  split: function(a, b) {
    ...
    1 <= b &&
      ...
      (c.crystal = +d[17] || 0),
      (c.deuterium = +d[18] || 0),
      (c.preferResource = +d[19] || 0),
      (c.timeResource = +d[20] || 0),
      (c.resources = c.metal + c.crystal + c.deuterium));
    if (2 <= b)
      for (c.timeShip = +d[21] || 0, c.ships = 0, f = 22; 35 >= f; f++)
        if (((e = +d[f] || 0), (c[String(f + 180)] = e))) c.ships += e;
    return c;
  },
  join: function(a, b) {
    var c, d;
  ...
  checkCoords: function(a, b, c) {
    return (
      1 <= a &&
      a <= AGB.Uni.Info.galaxies &&
      1 <= b &&
      b <= AGB.Uni.Info.systems &&
      1 <= c &&
      c <= AGB.Uni.Info.positions
    );
  },
  ...
  getCoordsType: function(a) {
    return OBJ.is(a) &&
      AGB.Task.checkCoordsType(a.galaxy, a.system, a.position, a.type)
  ...
  updateCoordsType: function(a, b) {
    ...
    OBJ.is(a) &&
      b &&
      ((c = b.split(":")),
      NMR.isMinMax(+c[3], 1, 3) && (a.type = +c[3] || 0),
      AGB.Task.checkCoords(+c[0], +c[1], +c[2]) &&
        ((a.galaxy = +c[0] || 0),
        (a.system = +c[1] || 0),
        (a.position = +c[2] || 0),
        (a.coords = a.galaxy + ":" + a.system + ":" + a.position),
        (a.coordstype = a.type ? a.coords + ":" + a.type : "")));
  },
  cut: function(a, b) {
...
AGB.Construction = {
  ...
  Messages: function(a, b, c) {
    "List" === a
      ? AGB.Construction.List(b, c)
      : "Action" === a && AGB.Construction.Action(b, c);
  },
  Init: function(a, b) {
    var c, d;
    if ((c = AGB.App.getPlayer(a)))
      (d = OBJ.parse(b[AGB.Data.getKey(c, "Construction", "Data")])),
        (AGB.Construction.Data[c] = { version: d.version }),
        OBJ.iterate(d, function(a) {
          Array.isArray(d[a]) &&
            ((AGB.Construction.Data[c][a] = []),
  ...
  Save: function(a) {
    ...
    AGB.Data.isStatus(d) &&
      ...
      (a.backup || b.changed) &&
      (delete b.changed,
      (c = { version: AGB.Data.get("Construction", "Data", "version") }),
      OBJ.iterate(b, function(a) {
        Array.isArray(b[a]) &&
          b[a].length &&
          ((c[a] = []),
      ...
      a.save && (a.save[d + "_Construction_Data"] = JSON.stringify(c)),
      a.backup &&
        AGB.Data.isBackup(d, "Construction", "Data", 2) &&
        (a.backup.Construction_Data = JSON.stringify(c)));
  },
  Action: function(a, b) {
    var c, d, e, f, g, h, l;
    d = AGB.App.getPlayer(a);
    ...
    if (d && c && a.value)
      if (((e = a.action), "set" === e))
        ...
        (g = AGB.Construction.getKey(a.value)),
          (h = AGB.Construction.getIndex(a.value)),
          OBJ.is(c[g]) &&
            c[g][h] &&
            (c[g].splice(h, 1),
            (c.changed = true),
        ...
        (g = AGB.Construction.getKey(a.value)),
          ...
          OBJ.is(c[g]) &&
            ...
            OBJ.get(f, "id") &&
              g !== a.coords &&
              f.reserved &&
              (AGB.Task.updateCoordsType(f, a.coords),
              f.coordstype === a.coords &&
                (c[g].splice(h, 1),
                (g = f.coordstype),
        ...
        OBJ.is(c[g]) &&
          c[g][h] &&
          ((f = OBJ.create(c[g][h])), OBJ.get(f, "id")))
      ) {
        if (200 > +f.id) {
          if ((l = { increase: 1, decrease: -1 }[e] || 0)) f.increase += l;
  ...
  update: function(a, b) {
    ...
    if (OBJ.is(b) && AGB.Item.valid(b.id))
      if (
        ...
        (b.level = Math.max(b.level, 1)),
          (b.duration = b.time * b.level),
          (b.range = 0),
          (b.increase = 0),
          OBJ.iterate(AGB.Item.Resource, function(a) {
            var d;
        ...
        c in AGB.Item.Mining ||
        c in AGB.Item.Station ||
        c in AGB.Item.Research
      )
        (d = OBJ.get(AGB.Item.Info[c], "factor")),
          (b.increase =
            c in AGB.Item.Research
              ? Math.max(b.increase || 0, 0)
              : Math.max(b.increase || 0, -1 * b.level)),
          (b.range = b.reserved
            ? 0
            : 0 > b.increase
              ? Math.max(Math.min(b.level + b.increase, b.range || 0), 0)
              : Math.max(b.range || 0, 0)),
          0 > b.increase
            ? ((f = Math.max(b.level + b.increase, 0)),
              (e = Math.max(f - b.range, 0)),
              (g = 4 * AGB.Units.Get(a, "account", "121")))
            : (0 < b.increase
                ? ((e = b.level + b.increase), (f = e + b.range))
                : (e = f = b.level),
              (g = 0)),
          (b.start = e),
          (b.stop = f),
          ...
          (b.duration = Math.floor((h.metal + h.crystal) * b.time)),
          (b.resources = b.metal + b.crystal + b.deuterium);
  },
  List: function(a, b) {
    var c, d, e;
    ...
    d &&
      c &&
      ((e = { tab: "Construction", list: c }),
      (e.Active = AGB.Units.SummarizePosition({
        keyPlayer: d,
        planet: a.active
      })),
      (e.Units =
        a.planet && "account" !== a.planet
          ? AGB.Units.SummarizePosition(a)
          : AGB.Units.SummarizeAccount(a)));
    AGB.Panel.Cache(a, e);
    b && b(e);
  },
  split: function(a) {
...
AGB.Token = {
  ...
  Messages: function(a, b, c) {
    "Get" === a
      ? AGB.Token.Get(b, c)
      : "Action" === a
        ? AGB.Token.Action(b, c)
        : "List" === a && AGB.Token.List(b, c);
  },
  Init: function(a, b) {
    var c;
    if ((c = AGB.App.getPlayer(a)))
      (AGB.Token.Data[c] = {}),
        (AGB.Token.Sort[c] = {}),
        AGB.Data.iterate("Token", function(a, e) {
          2 <= a.tab
            ? ((AGB.Token.Data[c][e] = OBJ.parse(
                b[AGB.Data.getKey(c, "Token", e)]
              )),
              AGB.Token.Upgrade(c, e))
  ...
  InitInfo: function(a) {
    ...
    (c = AGB.App.getPlayer(a)) &&
      AGB.Token.Data[c] &&
      ((AGB.Token.Data[c].Info = {}),
      (b = AGB.Token.Data[c].Info),
      OBJ.iterate(AGB.Token.Info, function(a) {
        var e;
        b[a] = {};
  ...
  Save: function(a) {
    ...
    OBJ.iterate(b, function(d) {
      AGB.Data.isStorage(c, "Token", d) &&
        (a.backup || b[d].changed) &&
        (delete b[d].changed,
        a.save &&
          (a.save[AGB.Data.getKey(c, "Token", d)] = JSON.stringify(b[d])),
        a.backup &&
          AGB.Data.isBackup(c, "Token", d, 2) &&
          (a.backup["Token_" + d] = JSON.stringify(b[d])));
    });
  },
  Action: function(a, b) {
    var c, d, e, f, g, h, l, p;
    ...
    f =
      -1 === f
        ? f
        : "Alliance" !== e || (!NMR.isMinMax(f, 41, 49) && 81 !== f)
          ? "Player" === e && NMR.isMinMax(f, 51, 89)
            ? f
            : "Target" === e && NMR.isMinMax(f, 61, 89)
              ? f
              : 0
          : f;
    d &&
      ...
      "Target" === e &&
        (1e8 < a.time
          ? (g = AGB.Task.cutCoordsType(a.coords) || a.time)
          : ((a.time = 0), (g = g || AGB.Task.cutCoords(a.coords)))),
      (p = {
        tab: e,
        action: a.action,
        id: g,
      ...
      "set" === a.action &&
        ((h = f + "|" + STR.check(a.name)),
        "Alliance" === e && a.tag && (h += "|" + a.tag),
        "Target" === e &&
        ...
        : 81 === f &&
          ...
          "set" === a.action
            ? ((p.changed = true),
              ...
              (l = Math.max(0, l - AGB.Option.Get(d, "I05"))),
              OBJ.iterate(c.Current, function(a) {
        ...
        OBJ.iterate(c.Current, function(a) {
          if ("version" !== a && "changed" !== a) {
            ...
            a[0] === f[0] &&
              81 <= b &&
              89 >= b &&
              ((a = a.slice(1)), d[f][b] ? d[f][b].push(a) : (d[f][b] = [a]));
          }
        })),
      ...
      a.token &&
        ...
        "Target" === f && a.sort
          ? g.listToken.sort(function(a, b) {
              var c = (OBJ.get(a, "coords") || "").split(":"),
                d = (OBJ.get(b, "coords") || "").split(":");
              return +c[0] < +d[0]
                ? -1
                : +c[0] > +d[0]
                  ? 1
          ...
          : g.listToken.sort(function(a, b) {
              var c = (OBJ.get(a, "name") || "").toLowerCase(),
                d = (OBJ.get(b, "name") || "").toLowerCase();
    ...
    OBJ.is(a) &&
      ...
      (80 > c
        ? OBJ.is(a[b]) &&
          ...
          "Target" === b &&
            ((e.coords = AGB.Token.getCoords(a[b], d)),
            (e.time = AGB.Token.getTime(a[b], d))))
        : 81 === c &&
          OBJ.is(a.Current) &&
          a.Current[b[0] + d] &&
          ((e = {
          ...
          "Target" === b &&
            ((e.coords = AGB.Token.getCoords(a.Current, b[0] + d)),
            (e.time = AGB.Token.getTime(a.Current, b[0] + d)))));
    return e || "";
  },
  getName: function(a, b) {
    return OBJ.is(a) && b ? STR.check(a[b]).split("|")[1] || "" : "";
  },
  ...
  getTime: function(a, b) {
    var c;
    return OBJ.is(a) && b
      ? ((c = +STR.check(a[b]).split("|")[3] || 0), 1e8 < c ? c : 0)
      : 0;
  },
  getColor: function(a, b) {
    return AGB.Token.is(a, "Info") && AGB.Token.Data[a].Info[b]
      ? AGB.Token.Data[a].Info[b].color || ""
      : "";
  },
  getClass: function(a, b) {
    return AGB.Token.is(a, "Info") && AGB.Token.Data[a].Info[b]
      ? "status_abbr_" + (AGB.Token.Data[a].Info[b].cls || b)
      : "";
  },
  getCondition: function(a, b) {
    return AGB.Token.is(a, "Info") && AGB.Token.Data[a].Info[b]
      ? +AGB.Token.Data[a].Info[b].condition || 0
      : 0;
  },
  getOpacity: function(a, b) {
    return AGB.Token.is(a, "Info") && AGB.Token.Data[a].Info[b]
      ? +AGB.Token.Data[a].Info[b].opacity || 0
      : 0;
  },
  getColorOpacity: function(a, b, c) {
    ...
    return d
      ? ((e =
          e || (80 > b ? AGB.Option.Get(a, "CT2") : AGB.Styles.opacity) || 100),
        "INHERIT" === d ? e / 100 : AGB.Styles.getColor(d, c ? 2 * e : e))
      : "";
  },
  getTab: function(a) {
    return OBJ.is(a) &&
      a.keyPlayer &&
      AGB.Token.Data[a.keyPlayer] &&
      a.tab &&
      OBJ.is(AGB.Token.Data[a.keyPlayer][a.tab])
      ? a.tab
      : "";
  },
  is: function(a, b) {
...
AGB.Fleet = {
  ...
  Init: function(a, b) {
    ...
    if ((e = AGB.App.getPlayer(a)))
      (c = AGB.Fleet.Data[e] = {
        version: AGB.Data.get("Fleet", "Data", "version")
      }),
        (d = OBJ.parse(b[AGB.Data.getKey(e, "Fleet", "Data")])),
        (f = c.version !== d.version),
        AGB.Data.iterate("Fleet", function(a, b) {
          2 <= a.tab
  ...
  Save: function(a) {
    ...
    AGB.Data.isStatus(c) &&
      ...
      (a.backup || b.changed) &&
      (delete b.changed,
      a.save && (a.save[c + "_Fleet_Data"] = JSON.stringify(b)),
      a.backup &&
        AGB.Data.isBackup(c, "Fleet", "Data", 2) &&
        (a.backup.Fleet_Data = JSON.stringify(b)));
  },
  Set: function(a) {
    var b, c, d, e;
    c = AGB.App.getPlayer(a);
  ...
  Action: function(a) {
    ...
    if (c && d && b && "Last" === d && OBJ.get(a.data, "coords"))
      if (
        (Array.isArray(b.Last) || (b.Last = []),
        (d = a.data),
        (e = +d.routine || 0),
        (f = d.mission),
        (d.routine = 0),
        !e || VAL.check(e, 1, 2, 3, 4))
      ) {
        ...
        2 !== f && delete d.union;
        if (3 === e)
          1 === f && (d.routine = 3), (d.metal = d.crystal = d.deuterium = 0);
        else if (4 === e)
          8 === f && (d.routine = 4), (d.metal = d.crystal = d.deuterium = 0);
        else if (2 === e || d.resources)
          !d.resources || (3 !== f && 4 !== f)
            ? (d.metal = d.crystal = d.deuterium = 0)
            : (d.routine = 2);
        e = [AGB.Task.join(d, 2)];
        for (c = 0; c < b.Last.length; c++)
          (a = AGB.Task.split(b.Last[c], 2)),
            a.mission &&
              ((d.coordstype === AGB.Task.cutCoordsType(b.Last[c]) &&
                f === a.mission &&
                d.routine === a.routine) ||
                e.push(b.Last[c]));
        b.Last = [];
        ...
        5 === e
          ? ((a = AGB.Task.split(OBJ.get(b.Routine, "Collect"))),
            a.routine &&
              ((d.routine = a.routine),
              (e = AGB.Task.cut(AGB.Task.join(d), 10)),
              AGB.Fleet.Set({
                keyPlayer: c,
                tab: "Routine",
                data: { Collect: e }
          ...
          : 6 === e
            ? ((a = AGB.Task.split(OBJ.get(b.Routine, "Save"))),
              a.routine &&
                ((d.routine = a.routine),
                (e = AGB.Task.cut(AGB.Task.join(d), 10)),
                AGB.Fleet.Set({
            ...
            : 7 === e &&
              ((e = AGB.Task.cutSystem(a.coords)),
              15 === f &&
                e &&
                AGB.Fleet.Set({
                  keyPlayer: c,
                  tab: "Expo",
                  data: OBJ.createKey(e, (+OBJ.get(b.Expo, e) || 0) + 1)
                }));
  }
};
AGB.DataBase = {
  ...
  Messages: function(a, b, c) {
    OBJ.is(b) &&
      ("Remove" === a
        ? AGB.DataBase.Remove(b)
        : "Set" === a
          ? AGB.DataBase.Set(b, c)
          : "GetPlayer" === a
            ? AGB.DataBase.GetPlayer(b, c)
            : "GetPlanet" === a && AGB.DataBase.GetPlanet(b, c));
  },
  Start: function(a) {
    OBJ.is(a.indexedDB) &&
      "function" === typeof a.IDBKeyRange &&
      ((AGB.DataBase.indexedDB = a.indexedDB),
      (AGB.DataBase.IDBKeyRange = a.IDBKeyRange),
      (AGB.DataBase.status = 1));
  },
  Init: function(a) {
    var b;
    if ((b = AGB.App.getUni(a)))
      OBJ.is(AGB.DataBase.Data[b]) ||
        (AGB.DataBase.Data[b] = {
          status: 0,
          keyUni: a.keyUni,
          urlUni: a.urlUni
        }),
        (b = AGB.DataBase.Data[b]),
        0 <= b.status &&
          2 >= b.status &&
          ((b.status = 3),
          (b.keyPlayer = a.keyPlayer),
          (b.api = AGB.Option.Get(a.keyPlayer, "D20")),
          AGB.DataBase.Open(OBJ.create(b), "Player"));
  },
  Status: function(a) {
    var b, c;
    (c = AGB.App.getUni(a)) &&
      ...
      OBJ.iterate(AGB.DataBase.Info, function(a) {
        var e;
  ...
  get: function(a, b) {
    return a && b && OBJ.is(AGB.DataBase.Data[a]) ? AGB.DataBase.Data[a][b] : 0;
  },
  isStatus: function(a, b) {
    var c, d;
    if ((c = AGB.App.getUni(a)) && b && AGB.DataBase.Info[b]) {
  ...
  ObjectStore: function(a, b, c, d) {
    if (a && OBJ.is(AGB.DataBase.Data[a].db))
      try {
        d(
          AGB.DataBase.Data[a].db.transaction(b, c || "readonly").objectStore(b)
        );
      } catch (e) {
  ...
  Set: function(a) {
    ...
    OBJ.is(a) &&
      OBJ.is(a.data) &&
      ((b = AGB.DataBase.isStatus(a, "Player")),
      (a.api = AGB.DataBase.get(a.keyUni, "api")),
      b &&
        OBJ.is(a.data.Player) &&
        AGB.DataBase.ObjectStore(b, "I", "readwrite", function(b) {
          b &&
            OBJ.iterate(a.data.Player, function(d) {
              var e;
              e = a.data.Player[d];
              e.I &&
                (b.get(+d).onsuccess = function(d) {
                  d = d.target.result;
                  (d && e.N === d.N && e.s === d.s && e.aI === d.aI) ||
                    (a.api && AGB.Core.Log("Galaxy - Update Player " + e.N),
                    b.put(e));
                });
            });
        }),
      (b = AGB.DataBase.isStatus(a, "Universe")) &&
        OBJ.is(a.data.Planet) &&
        AGB.DataBase.ObjectStore(b, "pI", "readwrite", function(b) {
          b &&
            OBJ.iterate(a.data.Planet, function(d) {
              var e;
              e = a.data.Planet[d];
              b.index("c").get(d).onsuccess = function(f) {
                ...
                if (e && !f)
                  ...
                  if (e.I !== f.I)
                    AGB.Core.Log(
                      "Galaxy - Different player: " + d + " - Player " + f.I
                    ),
                      (f.c = "moved"),
                      b.put(f),
                      b.put(e);
                  else if (e.pI !== f.pI)
                    AGB.Core.Log("Galaxy - Different planet: " + d),
                      (f.c = "moved"),
                      b.put(f),
                      b.put(e);
                  else {
                  ...
                  !e &&
                    f &&
                    (AGB.Core.Log(
                      "Galaxy - Missing planet: " + d + " - Player " + f.I
                    ),
                    (f.c = "moved"),
                    b.put(f));
              };
  ...
  GetPlayer: function(a, b) {
    function c(c) {
      ...
      a.planets
        ? ((c = c || {}),
          AGB.DataBase.getPlanetsByPlayerId(a, function(e) {
            c.planets = e;
            Array.isArray(c.planets) &&
              (OBJ.iterateArray(c.planets, function(a) {
                a &&
                  (!c.planetHome || +a.planetId < +c.planetHome) &&
                  (c.planetHome = a.planetId);
              }),
              1 === a.planets
                ? c.planets.sort(function(a, b) {
                    var c, d;
    ...
    "function" === typeof b &&
      (a.id
        ? AGB.DataBase.getPlayerById(a, c)
        : a.coords
          ? AGB.DataBase.getPlanetByCoords(a, function(b) {
  ...
  GetPlanet: function(a, b) {
    "function" === typeof b &&
      (a.id
        ? b()
        : a.coords
          ? AGB.DataBase.getPlanetByCoords(a, function(c) {
              c = c || {};
              a.id = c.playerId;
      ...
      if ((c = AGB.DataBase.isStatus(a, "Player")))
        try {
          AGB.DataBase.ObjectStore(c, "I", "readonly", function(c) {
            c && +a.id
              ? (c.get(+a.id).onsuccess = function(a) {
                  var c;
                  a = a.target.result;
                  OBJ.is(a) &&
                    a.I &&
            ...
            c && +a.id
              ? ((d = []),
                (c
                  .index("I")
                  .openCursor(
                    AGB.DataBase.IDBKeyRange.only(+a.id)
                  ).onsuccess = function(a) {
                  var c, e;
                  a.target.result
                    ? ((e = a.target.result.value),
                      OBJ.get(e, "pI") &&
                        ((c = {
                          coords: e.c || "",
                          planetId: (e.pI || "") + "",
    ...
    if ("function" === typeof b)
      if ((c = AGB.DataBase.isStatus(a, "Universe")))
        try {
          AGB.DataBase.ObjectStore(c, "pI", "readonly", function(c) {
            c && a.coords
              ? (c.index("c").get(a.coords).onsuccess = function(a) {
                  var c;
                  a = a.target.result;
                  OBJ.is(a) &&
                    a.pI &&
  ...
  Open: function(a, b) {
    ...
    AGB.App.getUni(a) &&
      ...
      ((a.key = ""),
      (a.tab = b),
      AGB.DataBase.Info[a.tab] &&
        ((a.key = a.keyUni + "_" + a.tab),
        OBJ.is(AGB.DataBase.Data[a.key]) || (AGB.DataBase.Data[a.key] = {}),
        (d = AGB.DataBase.Data[a.key]),
        (f = +d.status || 0),
        (f = -1 > f ? f : 1 === f || 2 === f ? f : 0),
        (d.status = f)));
    0 > f
      ? AGB.DataBase.Check(a)
      : OBJ.is(d.db) && d.timestamp
        ? AGB.DataBase.Check(a)
        : ((d.status = 4),
          AGB.DataBase.Close(a.key),
          (e = AGB.DataBase.indexedDB.open(a.key, 2)),
          (e.onblocked = c),
          (e.onerror = c),
  ...
  isRead: function(a) {
    return AGB.status &&
      a.api &&
      a.key &&
      3 <= AGB.DataBase.get(a.keyUni, "status")
      ? AGB.DataBase.Data[a.key].status
      : 0;
  },
  Check: function(a) {
    var b, c, d;
    1 <= AGB.DataBase.isRead(a)
      ? ((b = AGB.DataBase.Data[a.key]),
        (b.status =
          1 !== b.status
            ? b.status
            : 1e3 > b.timestamp
              ? 2
              : AGB.Time.timestamp() - b.timestamp >
                3600 * AGB.DataBase.Info[a.tab].hour
                ? 2
                : 1),
        2 <= b.status &&
        (a.load ||
          ...
          ? ((c = new XMLHttpRequest()),
            ...
            (c.onerror = c.onload = function() {
              AGB.DataBase.isRead(a) &&
                ...
                (b.timestampHeader = Math.floor(
                  new Date(c.getResponseHeader("Last-Modified")).getTime() / 1e3
                )),
                200 === +c.status && 1e4 < b.timestampHeader
                  ? (b.status =
                      b.timestamp / 100 < b.timestampHeader / 100 ? 3 : 1)
                  : ((b.timestampHeader = 0),
                    AGB.Core.Log(
            ...
            c.send(null))
          : AGB.DataBase.Read(a))
      : ((d = AGB.DataBase.get(a.key, "status")),
        -1 === d &&
          AGB.Core.Log(
        ...
        -2 === d &&
          AGB.Core.Log(
            "DataBase   - Problem: Please delete the database " +
              a.tab +
              " for the universe " +
              a.keyUni,
            true
  ...
  Read: function(a) {
    function b(b, d) {
      function g() {
        var b, d;
        q++;
        if (3 !== AGB.DataBase.isRead(a)) c();
        else if (q < k.length) {
          d = " " + k[q];
          b = +STR.getAttribute(d, "id") || q;
          var f = STR.getAttribute(d, "name"),
            h = STR.getAttribute(d, "status"),
            l = 21;
          h &&
            (h[0] && (l = Math.max(+t[h[0]] || 0, l)),
            h[1] && (l = Math.max(+t[h[1]] || 0, l)),
            h[2] && (l = Math.max(+t[h[2]] || 0, l)));
          b = { I: b, N: f, s: l };
          if ((d = +STR.getAttribute(d, "alliance") || 0)) b.aI = d;
          0 === q % Math.ceil(k.length / 100) &&
            ((e.loading = Math.ceil(q / (k.length / 100)) || 1),
            AGB.Manager.message(a, "DataBase", "Notify", {
              tab: a.tab,
              loading: e.loading
            }));
          s.add(b).onsuccess = g;
      ...
      function m() {
        ...
        3 !== AGB.DataBase.isRead(a)
          ...
          : q < k.length &&
            ((d = (" " + k[q]).split("<moon")),
            (b = {
              pI: +STR.getAttribute(d[0], "id") || q,
              I: +STR.getAttribute(d[0], "player") || 2,
              pN: STR.getAttribute(d[0], "name"),
              c: STR.getAttribute(d[0], "coords")
            }),
            d[1] &&
              ((b.mI = +STR.getAttribute(d[1], "id") || 0),
              (b.mN = STR.getAttribute(d[1], "name"))),
            0 === q % Math.ceil(k.length / 100) &&
              ((e.loading = Math.ceil(q / (k.length / 100)) || 1),
              AGB.Manager.message(a, "DataBase", "Notify", {
                tab: a.tab,
      ...
      e.timestamp =
        e.timestampHeader ||
        +STR.getAttribute(k[0], "timestamp") ||
        AGB.Time.timestamp();
      r.objectStoreNames.contains("info") &&
      r.objectStoreNames.contains(f.keyPath)
        ? ((n = r.transaction("info", "readwrite")),
          n.objectStore("info").put(0, "timestampServer"),
          n.objectStore("info").put(0, "entries"),
          (n = r.transaction(f.keyPath, "readwrite")),
          (n.onabort = function() {
            c(1);
          }),
          (n.ontimeout = c),
          (n.oncomplete = function() {
            ...
            3 === AGB.DataBase.isRead(a) &&
              ((n = r.transaction("info", "readwrite")),
              n.objectStore("info").put(e.timestamp, "timestampServer"),
              n.objectStore("info").put(e.entries, "entries"),
              c(1));
          }),
          (s = n.objectStore(f.keyPath)),
          s.clear(),
          "Player" === a.tab ? g() : "Universe" === a.tab && m())
        : c(-2);
    }
    ...
    function d(a) {
      "Player" === a.tab
        ? AGB.DataBase.Open(a, "Universe")
        : "Universe" === a.tab &&
          a.keyUni &&
          ((AGB.DataBase.Data[a.keyUni].status = 1),
          OBJ.iterate(AGB.DataBase.Info, function(b) {
            b = +AGB.DataBase.get(a.keyUni + "_" + b, "status") || 0;
            0 >= b && (AGB.DataBase.Data[a.keyUni].status = -1);
            3 <= b &&
              -1 !== AGB.DataBase.Data[a.keyUni].status &&
              (AGB.DataBase.Data[a.keyUni].status = 3);
          }));
    }
    ...
    3 === AGB.DataBase.isRead(a)
      ? (AGB.Core.Log("DataBase - Read     : " + a.key, true),
        ...
        (g.onerror = g.onload = function() {
          ...
          AGB.DataBase.isRead(a) &&
            ((d = g.responseText || ""),
            200 === +g.status && -1 < d.indexOf(f.split)
              ? (AGB.DataBase.Close(a.key),
                (e = AGB.DataBase.indexedDB.open(a.key)),
                (e.onerror = c),
                (e.onblocked = c),
                (e.onsuccess = function(a) {
                  b(a, d || "");
...
AGB.Tools = {
  ...
  Action: function(a, b) {
    ...
    if ((d = AGB.App.getPlayer(a, "copy"))) {
      e = { id: a.id };
      AGB.Option.Get(d, "T05") &&
        ((c = AGB.Task.splitActive(AGB.Option.Get(d, "T06"), 2, a.coordstype)),
        c.ships
          ? (a.Ships = OBJ.createFilter(c, AGB.Item.Ship))
          : a.planetId &&
            (a.Ships = AGB.Units.create(d, a.planetId, AGB.Item.ShipCombat)));
      if (OBJ.is(a.Search))
        switch (((a.tab = a.Search.tab), a.tab)) {
          case "Alliance":
            a.searchAlliance = a.Search.id;
            a.searchAllianceName = a.Search.name;
            a.searchAllianceTag = a.Search.tag;
            break;
          case "Player":
            ...
            break;
          case "Target":
            (a.searchTarget = a.Search.id),
              (a.searchTargetCoords = a.Search.coords);
        }
      else
        (a.searchAlliance = AGB.Panel.getActive(d, "Alliance", "id", 6)),
          (a.searchAllianceName = AGB.Panel.getActive(
            d,
            "Alliance",
            "name",
            6
          )),
          (a.searchAllianceTag = AGB.Panel.getActive(d, "Alliance", "tag", 6)),
          (a.searchPlayer = AGB.Panel.getActive(d, "Player", "id", 6)),
          (a.searchPlayerName = AGB.Panel.getActive(d, "Player", "name", 6)),
          (a.searchTarget = AGB.Panel.getActive(d, "Target", "id", 6)),
          (a.searchTargetCoords = AGB.Panel.getActive(
            d,
            "Target",
            "coords",
            6
  ...
  createLink: function(a) {
    ...
    b =
      AGB.Tools.Links[a.id] ||
      STR.check(AGB.Option.Get(b, a.id)).split("|", 2)[1];
    if ((b = STR.check(b).trim()))
      "http:/" !== b.slice(0, 6).toLowerCase() &&
        "https:/" !== b.slice(0, 7).toLowerCase() &&
        (b = "http://" + b),
        (b = b.replace(/\[UNI\]/g, NMR.parseIntAbs(a.abbrUni) || "")),
        (b = b.replace(/\[ALLIANCE\]/g, a.searchAlliance || "")),
        (b = b.replace(/\[ALLIANCENAME\]/g, a.searchAllianceName || "")),
        (b = b.replace(/\[ALLIANCETAG\]/g, a.searchAllianceTag || "")),
        (b = b.replace(/\[PLAYER\]/g, a.searchPlayer || "")),
        (b = b.replace(/\[PLAYERNAME\]/g, a.searchPlayerName || "")),
        (b = b.replace(/\[TARGET\]/g, a.searchTarget || "")),
        (b = b.replace(/\[TARGETCOORDS\]/g, a.searchTargetCoords || "")),
        (b = b.replace(/\[TARGETMOON\]/g, a.searchTargetMoon || "")),
        (a.href = b);
  },
  createWarRiders: function(a) {
    ...
    if ((c = AGB.Com.Get(a.abbrCom, "warriders")))
      (b =
        "Alliance" === a.tab
          ? "&page=details&type=ally&name=" + (a.searchAllianceTag || "")
          : "Player" === a.tab
            ? "&page=details&type=player&name=" + (a.searchPlayerName || "")
            : ""),
        (a.href =
          "http://ogame.gamestats.org/?lang=" +
          c +
          "&uni=" +
  ...
  createInfuza: function(a) {
    ...
    b =
      "Alliance" === a.tab
        ? "&pora=alliances&value=" + (a.searchAllianceTag || "")
        : "Player" === a.tab
          ? "&pora=players&value=" + (a.searchPlayerName || "")
          : "";
    a.href =
      "http://www.infuza.com/" +
      AGB.Com.Get(a.abbrCom, "infuza") +
      "/Search?server=" +
      AGB.Com.Get(a.abbrCom, "infuzaServer") +
      encodeURI(b);
  },
  createOgniter: function(a) {
    ...
    b =
      "Alliance" === a.tab
        ? "/alliance/" + (a.searchAlliance || "")
        : "Player" === a.tab
          ? "/player/" + (a.searchPlayer || "")
          : "";
    a.href =
      "http://www.ogniter.org/" +
      AGB.Com.Get(a.abbrCom, "ogniter") +
      "/" +
      AGB.Com.Get(a.abbrCom, "ogniter") +
      NMR.parseIntAbs(a.abbrUni) +
      encodeURI(b);
  },
  createCumulative: function(a) {
    ...
    b = AGB.App.getPlayer(a, "copy");
    c =
      "http://calc.antigame.de/?lang=" +
      (a.abbrCom || "").toLowerCase() +
      "&coords=" +
      (a.coords || "") +
      "&type=" +
      (a.type || "") +
      ...
      AGB.Uni.Get(b, "speed") +
      "&robo=" +
      AGB.Units.Get(b, a.planetId, "14") +
      "&nanite=" +
      AGB.Units.Get(b, a.planetId, "15") +
      "&rlab=" +
      AGB.Units.Get(b, a.planetId, "31") +
      (AGB.Option.Get(b, "technocrat") ? "&technocrat=1" : "");
    ...
    OBJ.iterate(AGB.Item.Research, function(a) {
      c += STR.addUrlPara(a + "c", AGB.Units.Get(b, "account", a));
    });
    a.href = c;
  },
  createOcalcAmortisation: function(a) {
    ...
    b = AGB.App.getPlayer(a, "copy");
    d =
      AGB.Option.Get(b, "commander") &&
      AGB.Option.Get(b, "admiral") &&
      AGB.Option.Get(b, "engineer") &&
      AGB.Option.Get(b, "geologist") &&
      AGB.Option.Get(b, "technocrat")
        ? "1.12"
        : AGB.Option.Get(b, "geologist")
          ? "1.1"
          : "1";
    c =
      "http://www.o-calc.com/?sec=_amortisation&lang=" +
      (a.abbrCom || "").toLowerCase() +
      "&p=" +
      AGB.Units.Get(b, "account", "122") +
      "&g=" +
      d +
      "&em=2&ec=1&ed=1&s=" +
      AGB.Uni.Get(b, "speed") +
    ...
    OBJ.iterate(a.Planets, function(d) {
      c +=
        ...
        "." +
        AGB.Units.Get(b, d, "2").toString(36) +
        "." +
        AGB.Units.Get(b, d, "3").toString(36) +
        "+";
    });
    a.href = c;
  },
  createOsimulate: function(a) {
    ...
    b = a.Task;
    d =
      "http://www.osimulate.com/?ref=antigame&lang=" +
      AGB.Com.Get(a.abbrCom, "osimulate") +
      "&uni=" +
      a.abbrCom +
      "_" +
      a.abbrUni +
      "&uni_speed=" +
      AGB.Uni.Get(c, "speedFleet") +
      "&fleet_debris=" +
      100 * AGB.Uni.Get(c, "debrisFactor") +
      "&defense_debris=" +
      (AGB.Uni.Get(c, "defToTF") ? 100 * AGB.Uni.Get(c, "debrisFactor") : "0") +
      "&rapidfire=" +
      (AGB.Uni.Get(c, "rapidFire") ? 1 : 0) +
      "&start_pos=" +
      (a.coords || "") +
      "&engine0_0=" +
      AGB.Units.Get(c, "account", "115") +
      "&engine0_1=" +
      AGB.Units.Get(c, "account", "117") +
      "&engine0_2=" +
      AGB.Units.Get(c, "account", "118");
    d =
      b && !b.timeResearch && AGB.Option.Get(c, "T03")
        ? d + "&del_techs=1"
        : d +
          ("&tech_a0_0=" +
            AGB.Units.Get(c, "account", "109") +
            "&tech_a0_1=" +
            AGB.Units.Get(c, "account", "110") +
            "&tech_a0_2=" +
            AGB.Units.Get(c, "account", "111"));
    OBJ.iterate(a.Ships, function(b) {
      d += STR.addUrlPara("ship_a0_" + ((+b || 0) - 202) + "_b", a.Ships[b]);
    });
    b &&
      ((d +=
        "&tech_d0_0=" +
        ...
        "&plunder_perc=" +
        (b.plunder || "") +
        STR.addUrlPara("abm_b", b["502"])),
      OBJ.iterate(AGB.Item.Ship, function(a) {
        d += STR.addUrlPara("ship_d0_" + ((+a || 0) - 202) + "_b", b[a]);
      }),
      OBJ.iterate(AGB.Item.Defense, function(a) {
        1 === AGB.Item.Defense[a] &&
          (d += STR.addUrlPara("ship_d0_" + ((+a || 0) - 387) + "_b", b[a]));
      }));
    a.href = d;
  },
  createWebsim: function(a) {
    ...
    b = a.Task;
    d =
      "http://websim.speedsim.net/index.php?version=1&ref=antigame&lang=" +
      AGB.Com.Get(a.abbrCom, "websim") +
      "&uni=" +
      a.abbrCom +
      "_" +
      a.abbrUni +
  ...
  createDragosim: function(a) {
    ...
    d =
      "http://drago-sim.com/index.php?ref=antigame&lang=" +
      AGB.Com.Get(a.abbrCom, "dragosim") +
      "&uni=" +
      a.abbrCom +
      "_" +
      a.abbrUni +
      ...
      AGB.Uni.Get(c, "speedFleet") +
      "&debris_ratio=" +
      AGB.Uni.Get(c, "debrisFactor") +
      "&def_tf=" +
      Boolean(AGB.Uni.Get(c, "defToTF")) +
      "&rapid_fire=" +
      (AGB.Uni.Get(c, "rapidFire") ? 1 : 0);
    d =
      b && !b.timeResearch && AGB.Option.Get(c, "T03")
    ...
    b &&
      ((d +=
        ...
        "&plunder_perc=" +
        (b.plunder || "") +
        STR.addUrlPara("missiles_available_v", b["502"])),
      OBJ.iterate(AGB.Item.Ship, function(a) {
